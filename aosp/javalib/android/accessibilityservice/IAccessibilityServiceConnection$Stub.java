...
public abstract class Stub extends Binder implements IAccessibilityServiceConnection {
  ...
  public static IAccessibilityServiceConnection asInterface(IBinder paramIBinder) {
    if (paramIBinder == null)
      return null; 
    IInterface iInterface = paramIBinder.queryLocalInterface("android.accessibilityservice.IAccessibilityServiceConnection");
    return (iInterface != null && iInterface instanceof IAccessibilityServiceConnection) ? (IAccessibilityServiceConnection)iInterface : new Proxy(paramIBinder);
  }
  ...
  public static boolean setDefaultImpl(IAccessibilityServiceConnection paramIAccessibilityServiceConnection) {
    if (Proxy.sDefaultImpl == null) {
      if (paramIAccessibilityServiceConnection != null) {
        Proxy.sDefaultImpl = paramIAccessibilityServiceConnection;
        return true;
      } 
      return false;
    } 
      ...
      switch (paramInt1) {
        ...
        case 34:
          ...
          if (paramParcel1.readInt() != 0) {
            Region region1 = (Region)Region.CREATOR.createFromParcel(paramParcel1);
          } else {
            paramParcel1 = null;
          } 
          setTouchExplorationPassthroughRegion(paramInt1, (Region)paramParcel1);
        ...
        case 33:
          ...
          setGestureDetectionPassthroughRegion(paramInt1, (Region)paramParcel1);
          paramParcel2.writeNoException();
          return true;
        case 32:
          paramParcel1.enforceInterface("android.accessibilityservice.IAccessibilityServiceConnection");
          ...
          takeScreenshot(paramInt1, (RemoteCallback)paramParcel1);
          paramParcel2.writeNoException();
          return true;
        case 31:
          paramParcel1.enforceInterface("android.accessibilityservice.IAccessibilityServiceConnection");
          paramInt1 = getWindowIdForLeashToken(paramParcel1.readStrongBinder());
          paramParcel2.writeNoException();
          paramParcel2.writeInt(paramInt1);
          return true;
        case 30:
          paramParcel1.enforceInterface("android.accessibilityservice.IAccessibilityServiceConnection");
          iBinder = getOverlayWindowToken(paramParcel1.readInt());
          paramParcel2.writeNoException();
        ...
        case 18:
          ...
          if (region != null) {
            ...
            region.writeToParcel(paramParcel2, 1);
          } else {
        ...
        case 10:
          ...
          if (accessibilityServiceInfo != null) {
            paramParcel2.writeInt(1);
            accessibilityServiceInfo.writeToParcel(paramParcel2, 1);
          } else {
            paramParcel2.writeInt(0);
          } 
          return true;
        case 9:
          ...
          if (windowListSparseArray != null) {
            paramParcel2.writeInt(1);
            windowListSparseArray.writeToParcel(paramParcel2, 1);
          } else {
            paramParcel2.writeInt(0);
          } 
          return true;
        case 8:
          ...
          if (accessibilityWindowInfo != null) {
            paramParcel2.writeInt(1);
            accessibilityWindowInfo.writeToParcel(paramParcel2, 1);
          } else {
            paramParcel2.writeInt(0);
          } 
          return true;
        case 7:
          ...
          paramInt2 = accessibilityWindowInfo.readInt();
          if (accessibilityWindowInfo.readInt() != 0) {
            Bundle bundle = (Bundle)Bundle.CREATOR.createFromParcel((Parcel)accessibilityWindowInfo);
          } else {
            parceledListSlice = null;
          } 
          bool1 = performAccessibilityAction(j, l1, paramInt2, (Bundle)parceledListSlice, accessibilityWindowInfo.readInt(), IAccessibilityInteractionConnectionCallback.Stub.asInterface(accessibilityWindowInfo.readStrongBinder()), accessibilityWindowInfo.readLong());
          paramParcel2.writeNoException();
        ...
        case 2:
          ...
          paramInt2 = arrayOfString.readInt();
          ...
          arrayOfString = findAccessibilityNodeInfoByAccessibilityId(i, l2, i2, iAccessibilityInteractionConnectionCallback, paramInt2, l1, (Bundle)arrayOfString);
          paramParcel2.writeNoException();
          paramParcel2.writeStringArray(arrayOfString);
          return true;
        case 1:
...
/* Location:              /home/chun/Desktop/temp/!/android/accessibilityservice/IAccessibilityServiceConnection$Stub.class
