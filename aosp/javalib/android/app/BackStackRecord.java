...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
  ...
  public BackStackRecord(FragmentManagerImpl paramFragmentManagerImpl) {
    ...
    if (paramFragmentManagerImpl.getTargetSdk() <= 25)
      bool = false; 
  ...
  int commitInternal(boolean paramBoolean) {
    if (!this.mCommitted) {
      if (FragmentManagerImpl.DEBUG) {
        ...
        dump("  ", null, (PrintWriter)fastPrintWriter, null);
      ...
      for (byte b = 0; b < i; b++) {
        ...
        switch (op.cmd) {
          default:
            ...
            break;
          case 9:
            str1 = "UNSET_PRIMARY_NAV";
            break;
          case 8:
            str1 = "SET_PRIMARY_NAV";
            break;
          case 7:
            str1 = "ATTACH";
            break;
  ...
  public CharSequence getBreadCrumbShortTitle() {
    return (this.mBreadCrumbShortTitleRes != 0 && this.mManager.mHost != null) ? this.mManager.mHost.getContext().getText(this.mBreadCrumbShortTitleRes) : this.mBreadCrumbShortTitleText;
  }
  ...
  public CharSequence getBreadCrumbTitle() {
    return (this.mBreadCrumbTitleRes != 0 && this.mManager.mHost != null) ? this.mManager.mHost.getContext().getText(this.mBreadCrumbTitleRes) : this.mBreadCrumbTitleText;
  }
...
/* Location:              /home/chun/Desktop/temp/!/android/app/BackStackRecord.class
