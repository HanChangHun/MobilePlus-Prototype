...
public abstract class Stub extends Binder implements IActivityTaskManager {
  ...
  public static IActivityTaskManager asInterface(IBinder paramIBinder) {
    if (paramIBinder == null)
      return null; 
    IInterface iInterface = paramIBinder.queryLocalInterface("android.app.IActivityTaskManager");
    return (iInterface != null && iInterface instanceof IActivityTaskManager) ? (IActivityTaskManager)iInterface : new Proxy(paramIBinder);
  }
  ...
  public static boolean setDefaultImpl(IActivityTaskManager paramIActivityTaskManager) {
    if (Proxy.sDefaultImpl == null) {
      if (paramIActivityTaskManager != null) {
        Proxy.sDefaultImpl = paramIActivityTaskManager;
        return true;
      } 
      return false;
    } 
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2) throws RemoteException {
    if (paramInt1 != 1598968902) {
      ...
      switch (paramInt1) {
        ...
        case 155:
          paramParcel1.enforceInterface("android.app.IActivityTaskManager");
          onBackPressedOnTaskRoot(paramParcel1.readStrongBinder(), IRequestFinishCallback.Stub.asInterface(paramParcel1.readStrongBinder()));
          paramParcel2.writeNoException();
          return true;
        case 154:
          paramParcel1.enforceInterface("android.app.IActivityTaskManager");
          restartActivityProcessIfVisible(paramParcel1.readStrongBinder());
          paramParcel2.writeNoException();
          return true;
        case 153:
          paramParcel1.enforceInterface("android.app.IActivityTaskManager");
          setDisplayToSingleTaskInstance(paramParcel1.readInt());
          paramParcel2.writeNoException();
          return true;
        case 152:
          paramParcel1.enforceInterface("android.app.IActivityTaskManager");
          clearLaunchParamsForPackages(paramParcel1.createStringArrayList());
          paramParcel2.writeNoException();
          return true;
        case 151:
          paramParcel1.enforceInterface("android.app.IActivityTaskManager");
        ...
        case 150:
          paramParcel1.enforceInterface("android.app.IActivityTaskManager");
          bool21 = getPackageAskScreenCompat(paramParcel1.readString());
          paramParcel2.writeNoException();
          paramParcel2.writeInt(bool21);
          return true;
        case 149:
          paramParcel1.enforceInterface("android.app.IActivityTaskManager");
        ...
        case 148:
          paramParcel1.enforceInterface("android.app.IActivityTaskManager");
          i16 = getPackageScreenCompatMode(paramParcel1.readString());
          paramParcel2.writeNoException();
          paramParcel2.writeInt(i16);
          return true;
        case 147:
          paramParcel1.enforceInterface("android.app.IActivityTaskManager");
          iVoiceInteractionSession1 = IVoiceInteractionSession.Stub.asInterface(paramParcel1.readStrongBinder());
          bool43 = bool22;
          if (paramParcel1.readInt() != 0)
            bool43 = true; 
        ...
        case 146:
          paramParcel1.enforceInterface("android.app.IActivityTaskManager");
          iActivityController = IActivityController.Stub.asInterface(paramParcel1.readStrongBinder());
          bool43 = bool23;
          if (paramParcel1.readInt() != 0)
            bool43 = true; 
        ...
        case 141:
          ...
          alwaysShowUnsupportedCompileSdkWarning((ComponentName)paramParcel1);
          paramParcel2.writeNoException();
          return true;
        case 140:
          paramParcel1.enforceInterface("android.app.IActivityTaskManager");
          ...
          if (paramParcel1.readInt() != 0) {
            RemoteAnimationDefinition remoteAnimationDefinition = (RemoteAnimationDefinition)RemoteAnimationDefinition.CREATOR.createFromParcel(paramParcel1);
          } else {
            paramParcel1 = null;
          } 
          registerRemoteAnimationsForDisplay(i16, (RemoteAnimationDefinition)paramParcel1);
          paramParcel2.writeNoException();
          return true;
        case 139:
          paramParcel1.enforceInterface("android.app.IActivityTaskManager");
          ...
          if (paramParcel1.readInt() != 0) {
            RemoteAnimationAdapter remoteAnimationAdapter = (RemoteAnimationAdapter)RemoteAnimationAdapter.CREATOR.createFromParcel(paramParcel1);
          } else {
            paramParcel1 = null;
          } 
          registerRemoteAnimationForNextActivityStart(str5, (RemoteAnimationAdapter)paramParcel1);
          paramParcel2.writeNoException();
          return true;
        case 138:
          paramParcel1.enforceInterface("android.app.IActivityTaskManager");
          unregisterRemoteAnimations(paramParcel1.readStrongBinder());
          paramParcel2.writeNoException();
          return true;
        case 137:
          paramParcel1.enforceInterface("android.app.IActivityTaskManager");
          ...
          registerRemoteAnimations(iBinder5, (RemoteAnimationDefinition)paramParcel1);
          paramParcel2.writeNoException();
          return true;
        case 136:
          paramParcel1.enforceInterface("android.app.IActivityTaskManager");
        ...
        case 132:
          ...
          bool20 = updateConfiguration((Configuration)paramParcel1);
          paramParcel2.writeNoException();
        ...
        case 130:
          paramParcel1.enforceInterface("android.app.IActivityTaskManager");
          invalidateHomeTaskSnapshot(paramParcel1.readStrongBinder());
          paramParcel2.writeNoException();
          return true;
        case 129:
          paramParcel1.enforceInterface("android.app.IActivityTaskManager");
        ...
        case 125:
          ...
          if (configurationInfo != null) {
            paramParcel2.writeInt(1);
            configurationInfo.writeToParcel(paramParcel2, 1);
          } else {
            paramParcel2.writeInt(0);
          } 
          return true;
        ...
        case 119:
          ...
          paramParcel2.writeStrongBinder((IBinder)iWindowOrganizerController);
          return true;
        case 118:
        ...
        case 99:
          ...
          paramInt2 = componentName2.readInt();
          if (componentName2.readInt() != 0) {
            Bundle bundle = (Bundle)Bundle.CREATOR.createFromParcel((Parcel)componentName2);
          } else {
            componentName2 = null;
          } 
          bool15 = launchAssistIntent((Intent)iBinder4, i11, str8, paramInt2, (Bundle)componentName2);
          paramParcel2.writeNoException();
        ...
        case 96:
          ...
          if (stackInfo3 != null) {
            paramParcel2.writeInt(1);
            stackInfo3.writeToParcel(paramParcel2, 1);
          } else {
            paramParcel2.writeInt(0);
          } 
          return true;
        case 95:
          ...
          paramParcel2.writeNoException();
          paramParcel2.writeTypedList(list3);
          return true;
        case 94:
          ...
          if (stackInfo2 != null) {
            paramParcel2.writeInt(1);
            stackInfo2.writeToParcel(paramParcel2, 1);
          } else {
            paramParcel2.writeInt(0);
          } 
          return true;
        ...
        case 89:
          list2.enforceInterface("android.app.IActivityTaskManager");
          paramInt2 = list2.readInt();
          i9 = list2.readInt();
          bool43 = bool33;
          if (list2.readInt() != 0)
            bool43 = true; 
          moveTaskToStack(paramInt2, i9, bool43);
          paramParcel2.writeNoException();
          return true;
        case 88:
          list2.enforceInterface("android.app.IActivityTaskManager");
          ...
          if (list2.readInt() != 0)
            bool43 = true; 
          bool13 = setTaskWindowingMode(i9, paramInt2, bool43);
          paramParcel2.writeNoException();
        ...
        case 68:
          ...
          paramParcel2.writeNoException();
          paramParcel2.writeBinderList(list1);
          return true;
        case 67:
        ...
        case 59:
          ...
          if (rect1 != null) {
            paramParcel2.writeInt(1);
            rect1.writeToParcel(paramParcel2, 1);
          } else {
            paramParcel2.writeInt(0);
          } 
          return true;
        case 58:
          ...
          if (stackInfo1 != null) {
            paramParcel2.writeInt(1);
            stackInfo1.writeToParcel(paramParcel2, 1);
          } else {
            paramParcel2.writeInt(0);
          } 
          return true;
        ...
        case 52:
          ...
          if (taskDescription != null) {
            paramParcel2.writeInt(1);
            taskDescription.writeToParcel(paramParcel2, 1);
          } else {
            paramParcel2.writeInt(0);
          } 
          return true;
        ...
        case 36:
          ...
          paramInt2 = parceledListSlice.readInt();
          if (parceledListSlice.readInt() != 0) {
            Bundle bundle = (Bundle)Bundle.CREATOR.createFromParcel((Parcel)parceledListSlice);
          } else {
            parceledListSlice = null;
          } 
          moveTaskToFront(iApplicationThread1, str4, i2, paramInt2, (Bundle)parceledListSlice);
          paramParcel2.writeNoException();
          return true;
        case 35:
          parceledListSlice.enforceInterface("android.app.IActivityTaskManager");
        ...
        case 18:
          ...
          if (str1.readInt() != 0)
            bool43 = true; 
          activityIdle(iBinder3, (Configuration)paramParcel2, bool43);
          return true;
        case 17:
          str1.enforceInterface("android.app.IActivityTaskManager");
        ...
        case 13:
          ...
          if (str1.readInt() != 0)
            bool43 = true; 
          j = startActivityAsCaller(iApplicationThread3, str15, (Intent)iBinder3, str18, iBinder14, str22, paramInt2, j, (ProfilerInfo)iBinder7, (Bundle)iBinder9, iBinder17, bool43, str1.readInt());
          paramParcel2.writeNoException();
        ...
        case 10:
          ...
          j = startAssistantActivity(str13, str10, paramInt2, j, (Intent)iBinder3, str15, (Bundle)iBinder7, str1.readInt());
          paramParcel2.writeNoException();
          paramParcel2.writeInt(j);
          return true;
        case 9:
          ...
          j = startVoiceActivity(str15, str13, j, paramInt2, (Intent)iBinder3, str22, iVoiceInteractionSession2, iVoiceInteractor, i17, (ProfilerInfo)iBinder7, (Bundle)str10, str1.readInt());
          paramParcel2.writeNoException();
          paramParcel2.writeInt(j);
          return true;
        case 8:
          ...
          j = startActivityWithConfig(iApplicationThread5, str17, str13, (Intent)iBinder3, str19, iBinder17, str22, j, paramInt2, (Configuration)iBinder7, (Bundle)str10, str1.readInt());
          paramParcel2.writeNoException();
          paramParcel2.writeInt(j);
          return true;
        case 7:
          ...
          waitResult = startActivityAndWait(iApplicationThread5, str13, str17, (Intent)iBinder3, str19, iBinder15, str23, paramInt2, j, (ProfilerInfo)iBinder7, (Bundle)str10, str1.readInt());
          paramParcel2.writeNoException();
          if (waitResult != null) {
            paramParcel2.writeInt(1);
            waitResult.writeToParcel(paramParcel2, 1);
          } else {
            paramParcel2.writeInt(0);
          } 
          return true;
        case 6:
          ...
          paramInt2 = waitResult.readInt();
          if (waitResult.readInt() != 0) {
            Bundle bundle = (Bundle)Bundle.CREATOR.createFromParcel((Parcel)waitResult);
          } else {
            waitResult = null;
          } 
          j = startActivityIntentSender(iApplicationThread2, iIntentSender, iBinder11, (Intent)iBinder3, str14, iBinder15, str17, i17, j, paramInt2, (Bundle)waitResult);
          paramParcel2.writeNoException();
          paramParcel2.writeInt(j);
          return true;
        case 5:
        ...
        case 3:
          ...
          i = startActivityAsUser(iApplicationThread6, str12, str14, (Intent)iBinder3, str19, iBinder16, str21, i, paramInt2, (ProfilerInfo)iBinder6, (Bundle)iApplicationThread2, waitResult.readInt());
          paramParcel2.writeNoException();
      ...
      i = startActivity(iApplicationThread4, str9, str11, (Intent)iBinder3, str20, iBinder13, str16, paramInt2, i, (ProfilerInfo)str7, (Bundle)waitResult);
      paramParcel2.writeNoException();
      paramParcel2.writeInt(i);
      return true;
    } 
    paramParcel2.writeString("android.app.IActivityTaskManager");
    return true;
  }
...
/* Location:              /home/chun/Desktop/temp/!/android/app/IActivityTaskManager$Stub.class
