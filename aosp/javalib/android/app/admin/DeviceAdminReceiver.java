...
public class DeviceAdminReceiver extends BroadcastReceiver {
  ...
  public DevicePolicyManager getManager(Context paramContext) {
    ...
    this.mManager = devicePolicyManager1;
  ...
  public void onReceive(Context paramContext, Intent paramIntent) {
    ...
    if ("android.app.action.ACTION_PASSWORD_CHANGED".equals(str)) {
      ...
      if ("android.app.action.DEVICE_ADMIN_DISABLE_REQUESTED".equals(str)) {
        ...
        onDisabled((Context)charSequence, paramIntent);
      } else if ("android.app.action.ACTION_PASSWORD_EXPIRING".equals(str)) {
        onPasswordExpiring((Context)charSequence, paramIntent, (UserHandle)paramIntent.getParcelableExtra("android.intent.extra.USER"));
      } else if ("android.app.action.PROFILE_PROVISIONING_COMPLETE".equals(str)) {
        onProfileProvisioningComplete((Context)charSequence, paramIntent);
      } else if ("android.app.action.CHOOSE_PRIVATE_KEY_ALIAS".equals(str)) {
        setResultData(onChoosePrivateKeyAlias((Context)charSequence, paramIntent, paramIntent.getIntExtra("android.app.extra.CHOOSE_PRIVATE_KEY_SENDER_UID", -1), (Uri)paramIntent.getParcelableExtra("android.app.extra.CHOOSE_PRIVATE_KEY_URI"), paramIntent.getStringExtra("android.app.extra.CHOOSE_PRIVATE_KEY_ALIAS")));
      } else if ("android.app.action.LOCK_TASK_ENTERING".equals(str)) {
        onLockTaskModeEntering((Context)charSequence, paramIntent, paramIntent.getStringExtra("android.app.extra.LOCK_TASK_PACKAGE"));
      } else if ("android.app.action.LOCK_TASK_EXITING".equals(str)) {
        onLockTaskModeExiting((Context)charSequence, paramIntent);
      } else if ("android.app.action.NOTIFY_PENDING_SYSTEM_UPDATE".equals(str)) {
        onSystemUpdatePending((Context)charSequence, paramIntent, paramIntent.getLongExtra("android.app.extra.SYSTEM_UPDATE_RECEIVED_TIME", -1L));
      } else if ("android.app.action.BUGREPORT_SHARING_DECLINED".equals(str)) {
        onBugreportSharingDeclined((Context)charSequence, paramIntent);
      } else if ("android.app.action.BUGREPORT_SHARE".equals(str)) {
        onBugreportShared((Context)charSequence, paramIntent, paramIntent.getStringExtra("android.app.extra.BUGREPORT_HASH"));
      } else if ("android.app.action.BUGREPORT_FAILED".equals(str)) {
        onBugreportFailed((Context)charSequence, paramIntent, paramIntent.getIntExtra("android.app.extra.BUGREPORT_FAILURE_REASON", 0));
      } else if ("android.app.action.SECURITY_LOGS_AVAILABLE".equals(str)) {
        onSecurityLogsAvailable((Context)charSequence, paramIntent);
      } else if ("android.app.action.NETWORK_LOGS_AVAILABLE".equals(str)) {
        onNetworkLogsAvailable((Context)charSequence, paramIntent, paramIntent.getLongExtra("android.app.extra.EXTRA_NETWORK_LOGS_TOKEN", -1L), paramIntent.getIntExtra("android.app.extra.EXTRA_NETWORK_LOGS_COUNT", 0));
      } else if ("android.app.action.USER_ADDED".equals(str)) {
        onUserAdded((Context)charSequence, paramIntent, (UserHandle)paramIntent.getParcelableExtra("android.intent.extra.USER"));
      } else if ("android.app.action.USER_REMOVED".equals(str)) {
        onUserRemoved((Context)charSequence, paramIntent, (UserHandle)paramIntent.getParcelableExtra("android.intent.extra.USER"));
      } else if ("android.app.action.USER_STARTED".equals(str)) {
        onUserStarted((Context)charSequence, paramIntent, (UserHandle)paramIntent.getParcelableExtra("android.intent.extra.USER"));
      } else if ("android.app.action.USER_STOPPED".equals(str)) {
        onUserStopped((Context)charSequence, paramIntent, (UserHandle)paramIntent.getParcelableExtra("android.intent.extra.USER"));
      } else if ("android.app.action.USER_SWITCHED".equals(str)) {
        onUserSwitched((Context)charSequence, paramIntent, (UserHandle)paramIntent.getParcelableExtra("android.intent.extra.USER"));
      } else if ("android.app.action.TRANSFER_OWNERSHIP_COMPLETE".equals(str)) {
        onTransferOwnershipComplete((Context)charSequence, (PersistableBundle)paramIntent.getParcelableExtra("android.app.extra.TRANSFER_OWNERSHIP_ADMIN_EXTRAS_BUNDLE"));
      } else if ("android.app.action.AFFILIATED_PROFILE_TRANSFER_OWNERSHIP_COMPLETE".equals(str)) {
        onTransferAffiliatedProfileOwnershipComplete((Context)charSequence, (UserHandle)paramIntent.getParcelableExtra("android.intent.extra.USER"));
      } 
    } 
  }
...
/* Location:              /home/chun/Desktop/temp/!/android/app/admin/DeviceAdminReceiver.class
