...
public class SecurityLogTags {
  ...
  public static void writeSecurityCameraPolicySet(String paramString, int paramInt1, int paramInt2, int paramInt3) {
    EventLog.writeEvent(210034, new Object[] { paramString, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3) });
  }
  
  public static void writeSecurityCertAuthorityInstalled(int paramInt1, String paramString, int paramInt2) {
    EventLog.writeEvent(210029, new Object[] { Integer.valueOf(paramInt1), paramString, Integer.valueOf(paramInt2) });
  }
  
  public static void writeSecurityCertAuthorityRemoved(int paramInt1, String paramString, int paramInt2) {
    EventLog.writeEvent(210030, new Object[] { Integer.valueOf(paramInt1), paramString, Integer.valueOf(paramInt2) });
  }
  ...
  public static void writeSecurityPasswordComplexitySet(String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10) {
    EventLog.writeEvent(210017, new Object[] { 
          paramString, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3), Integer.valueOf(paramInt4), Integer.valueOf(paramInt5), Integer.valueOf(paramInt6), Integer.valueOf(paramInt7), Integer.valueOf(paramInt8), Integer.valueOf(paramInt9), 
          Integer.valueOf(paramInt10) });
  }
...
/* Location:              /home/chun/Desktop/temp/!/android/app/admin/SecurityLogTags.class
