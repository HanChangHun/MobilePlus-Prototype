...
public interface IJobCallback extends IInterface {
  ...
  public static abstract class Stub extends Binder implements IJobCallback {
    ...
    public static String getDefaultTransactionName(int param1Int) {
      return (param1Int != 1) ? ((param1Int != 2) ? ((param1Int != 3) ? ((param1Int != 4) ? ((param1Int != 5) ? null : "jobFinished") : "completeWork") : "dequeueWork") : "acknowledgeStopMessage") : "acknowledgeStartMessage";
    }
    
    public static boolean setDefaultImpl(IJobCallback param1IJobCallback) {
      if (Proxy.sDefaultImpl == null) {
        if (param1IJobCallback != null) {
...
/* Location:              /home/chun/Desktop/temp/!/android/app/job/IJobCallback.class
