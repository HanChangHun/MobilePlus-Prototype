...
public final class BluetoothClass implements Parcelable {
  public static final Parcelable.Creator<BluetoothClass> CREATOR = new Parcelable.Creator<BluetoothClass>() {
      public BluetoothClass createFromParcel(Parcel param1Parcel) {
        return new BluetoothClass(param1Parcel.readInt());
      }
      
      public BluetoothClass[] newArray(int param1Int) {
        return new BluetoothClass[param1Int];
      }
    };
  ...
  public boolean equals(Object paramObject) {
    boolean bool = paramObject instanceof BluetoothClass;
    boolean bool1 = false;
    if (bool) {
  ...
  public byte[] getClassOfDeviceBytes() {
    byte[] arrayOfByte = ByteBuffer.allocate(4).order(ByteOrder.BIG_ENDIAN).putInt(this.mClass).array();
...
/* Location:              /home/chun/Desktop/temp/!/android/bluetooth/BluetoothClass.class
