...
public interface IBluetoothMap extends IInterface {
  ...
  public static abstract class Stub extends Binder implements IBluetoothMap {
    ...
    public static IBluetoothMap asInterface(IBinder param1IBinder) {
      if (param1IBinder == null)
        return null; 
      IInterface iInterface = param1IBinder.queryLocalInterface("android.bluetooth.IBluetoothMap");
      return (iInterface != null && iInterface instanceof IBluetoothMap) ? (IBluetoothMap)iInterface : new Proxy(param1IBinder);
    }
    ...
    public static boolean setDefaultImpl(IBluetoothMap param1IBluetoothMap) {
      if (Proxy.sDefaultImpl == null) {
        if (param1IBluetoothMap != null) {
          Proxy.sDefaultImpl = param1IBluetoothMap;
          return true;
        } 
        return false;
      } 
    ...
    public boolean onTransact(int param1Int1, Parcel param1Parcel1, Parcel param1Parcel2, int param1Int2) throws RemoteException {
      if (param1Int1 != 1598968902) {
        ...
        switch (param1Int1) {
          ...
          case 9:
            param1Parcel1.enforceInterface("android.bluetooth.IBluetoothMap");
      ...
      param1Parcel2.writeString("android.bluetooth.IBluetoothMap");
      return true;
    }
  ...
  private static class Proxy implements IBluetoothMap {
    ...
    public boolean disconnect(BluetoothDevice param1BluetoothDevice) throws RemoteException {
      ...
      try {
        ...
        if (!this.mRemote.transact(3, parcel1, parcel2, 0) && IBluetoothMap.Stub.getDefaultImpl() != null) {
          bool = IBluetoothMap.Stub.getDefaultImpl().disconnect(param1BluetoothDevice);
          return bool;
        } 
        parcel2.readException();
        int i = parcel2.readInt();
    ...
    public int getConnectionPolicy(BluetoothDevice param1BluetoothDevice) throws RemoteException {
      ...
      try {
        ...
        if (!this.mRemote.transact(9, parcel1, parcel2, 0) && IBluetoothMap.Stub.getDefaultImpl() != null)
          return IBluetoothMap.Stub.getDefaultImpl().getConnectionPolicy(param1BluetoothDevice); 
        parcel2.readException();
        return parcel2.readInt();
      } finally {
        parcel2.recycle();
    ...
    public int getConnectionState(BluetoothDevice param1BluetoothDevice) throws RemoteException {
      ...
      try {
        ...
        if (!this.mRemote.transact(7, parcel1, parcel2, 0) && IBluetoothMap.Stub.getDefaultImpl() != null)
          return IBluetoothMap.Stub.getDefaultImpl().getConnectionState(param1BluetoothDevice); 
        parcel2.readException();
        return parcel2.readInt();
      } finally {
        parcel2.recycle();
    ...
    public List<BluetoothDevice> getDevicesMatchingConnectionStates(int[] param1ArrayOfint) throws RemoteException {
      ...
      try {
        ...
        if (!this.mRemote.transact(6, parcel1, parcel2, 0) && IBluetoothMap.Stub.getDefaultImpl() != null)
          return IBluetoothMap.Stub.getDefaultImpl().getDevicesMatchingConnectionStates(param1ArrayOfint); 
        parcel2.readException();
        return parcel2.createTypedArrayList(BluetoothDevice.CREATOR);
      } finally {
        parcel2.recycle();
    ...
    public boolean isConnected(BluetoothDevice param1BluetoothDevice) throws RemoteException {
      ...
      try {
        ...
        if (!this.mRemote.transact(4, parcel1, parcel2, 0) && IBluetoothMap.Stub.getDefaultImpl() != null) {
          bool = IBluetoothMap.Stub.getDefaultImpl().isConnected(param1BluetoothDevice);
          return bool;
        } 
        parcel2.readException();
        int i = parcel2.readInt();
    ...
    public boolean setConnectionPolicy(BluetoothDevice param1BluetoothDevice, int param1Int) throws RemoteException {
      ...
      try {
        ...
        if (!this.mRemote.transact(8, parcel1, parcel2, 0) && IBluetoothMap.Stub.getDefaultImpl() != null) {
          bool = IBluetoothMap.Stub.getDefaultImpl().setConnectionPolicy(param1BluetoothDevice, param1Int);
          return bool;
        } 
        parcel2.readException();
...
/* Location:              /home/chun/Desktop/temp/!/android/bluetooth/IBluetoothMap.class
