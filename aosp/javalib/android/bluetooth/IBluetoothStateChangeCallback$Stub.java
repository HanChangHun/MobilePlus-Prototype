...
public abstract class Stub extends Binder implements IBluetoothStateChangeCallback {
  ...
  public static IBluetoothStateChangeCallback asInterface(IBinder paramIBinder) {
    if (paramIBinder == null)
      return null; 
    IInterface iInterface = paramIBinder.queryLocalInterface("android.bluetooth.IBluetoothStateChangeCallback");
    return (iInterface != null && iInterface instanceof IBluetoothStateChangeCallback) ? (IBluetoothStateChangeCallback)iInterface : new Proxy(paramIBinder);
  }
  ...
  public static boolean setDefaultImpl(IBluetoothStateChangeCallback paramIBluetoothStateChangeCallback) {
    if (Proxy.sDefaultImpl == null) {
      if (paramIBluetoothStateChangeCallback != null) {
        Proxy.sDefaultImpl = paramIBluetoothStateChangeCallback;
        return true;
      } 
      return false;
    } 
...
/* Location:              /home/chun/Desktop/temp/!/android/bluetooth/IBluetoothStateChangeCallback$Stub.class
