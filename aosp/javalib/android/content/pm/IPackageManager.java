...
public interface IPackageManager extends IInterface {
  ...
  void grantImplicitAccess(int paramInt, String paramString) throws RemoteException;
  ...
  public static class Default implements IPackageManager {
    ...
    public void grantImplicitAccess(int param1Int, String param1String) throws RemoteException {}
      ...
      if (param1Int1 != 1598968902) {
        ...
        switch (param1Int1) {
          ...
          case 195:
            ...
            grantImplicitAccess(param1Parcel1.readInt(), param1Parcel1.readString());
            param1Parcel2.writeNoException();
            return true;
          case 194:
            param1Parcel1.enforceInterface("android.content.pm.IPackageManager");
            bool11 = isAutoRevokeWhitelisted(param1Parcel1.readString());
            param1Parcel2.writeNoException();
            param1Parcel2.writeInt(bool11);
            return true;
          case 193:
            param1Parcel1.enforceInterface("android.content.pm.IPackageManager");
            list2 = getMimeGroup(param1Parcel1.readString(), param1Parcel1.readString());
            param1Parcel2.writeNoException();
          ...
          case 139:
            ...
            if (keySet != null) {
              param1Parcel2.writeInt(1);
              keySet.writeToParcel(param1Parcel2, 1);
            } else {
              param1Parcel2.writeInt(0);
            } 
            return true;
          ...
          case 54:
            ...
            setLastChosenActivity((Intent)arrayList3, str10, param1Int2, (IntentFilter)arrayList2, k, (ComponentName)arrayOfString4);
            hashMap.writeNoException();
            return true;
          case 53:
            arrayOfString4.enforceInterface("android.content.pm.IPackageManager");
  ...
  private static class Proxy implements IPackageManager {
    ...
    public void addCrossProfileIntentFilter(IntentFilter param1IntentFilter, String param1String, int param1Int1, int param1Int2, int param1Int3) throws RemoteException {
      ...
      try {
        ...
        if (!this.mRemote.transact(61, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().addCrossProfileIntentFilter(param1IntentFilter, param1String, param1Int1, param1Int2, param1Int3);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public boolean addPermission(PermissionInfo param1PermissionInfo) throws RemoteException {
      ...
      try {
        parcel1.writeInterfaceToken("android.content.pm.IPackageManager");
        boolean bool = true;
        if (param1PermissionInfo != null) {
          parcel1.writeInt(1);
          param1PermissionInfo.writeToParcel(parcel1, 0);
        } else {
          parcel1.writeInt(0);
        } 
        if (!this.mRemote.transact(186, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().addPermission(param1PermissionInfo);
          return bool;
        } 
        parcel2.readException();
        int i = parcel2.readInt();
    ...
    public boolean addPermissionAsync(PermissionInfo param1PermissionInfo) throws RemoteException {
      ...
      try {
        ...
        if (!this.mRemote.transact(187, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().addPermissionAsync(param1PermissionInfo);
          return bool;
        } 
        parcel2.readException();
        int i = parcel2.readInt();
    ...
    public void addPersistentPreferredActivity(IntentFilter param1IntentFilter, ComponentName param1ComponentName, int param1Int) throws RemoteException {
      ...
      try {
        ...
        if (!this.mRemote.transact(59, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().addPersistentPreferredActivity(param1IntentFilter, param1ComponentName, param1Int);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void addPreferredActivity(IntentFilter param1IntentFilter, int param1Int1, ComponentName[] param1ArrayOfComponentName, ComponentName param1ComponentName, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int1);
        parcel1.writeTypedArray((Parcelable[])param1ArrayOfComponentName, 0);
        if (param1ComponentName != null) {
          parcel1.writeInt(1);
          param1ComponentName.writeToParcel(parcel1, 0);
        } else {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(55, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().addPreferredActivity(param1IntentFilter, param1Int1, param1ArrayOfComponentName, param1ComponentName, param1Int2);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public boolean canForwardTo(Intent param1Intent, String param1String, int param1Int1, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(28, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().canForwardTo(param1Intent, param1String, param1Int1, param1Int2);
          return bool;
        } 
        parcel2.readException();
    ...
    public boolean canRequestPackageInstalls(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(157, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().canRequestPackageInstalls(param1String, param1Int);
          return bool;
        } 
        parcel2.readException();
    ...
    public String[] canonicalToCurrentPackageNames(String[] param1ArrayOfString) throws RemoteException {
      ...
      try {
        ...
        if (!this.mRemote.transact(8, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1ArrayOfString = IPackageManager.Stub.getDefaultImpl().canonicalToCurrentPackageNames(param1ArrayOfString);
    ...
    public void checkPackageStartable(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(1, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().checkPackageStartable(param1String, param1Int);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public int checkPermission(String param1String1, String param1String2, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(189, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1Int = IPackageManager.Stub.getDefaultImpl().checkPermission(param1String1, param1String2, param1Int);
          return param1Int;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public int checkUidPermission(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(191, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1Int = IPackageManager.Stub.getDefaultImpl().checkUidPermission(param1String, param1Int);
          return param1Int;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public int checkUidSignatures(int param1Int1, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(17, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1Int1 = IPackageManager.Stub.getDefaultImpl().checkUidSignatures(param1Int1, param1Int2);
          return param1Int1;
        } 
        parcel2.readException();
        param1Int1 = parcel2.readInt();
    ...
    public void clearApplicationProfileData(String param1String) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String);
        if (!this.mRemote.transact(90, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().clearApplicationProfileData(param1String);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void clearApplicationUserData(String param1String, IPackageDataObserver param1IPackageDataObserver, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(89, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().clearApplicationUserData(param1String, param1IPackageDataObserver, param1Int);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void clearCrossProfileIntentFilters(int param1Int, String param1String) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String);
        if (!this.mRemote.transact(62, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().clearCrossProfileIntentFilters(param1Int, param1String);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void clearPackagePersistentPreferredActivities(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(60, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().clearPackagePersistentPreferredActivities(param1String, param1Int);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void clearPackagePreferredActivities(String param1String) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String);
        if (!this.mRemote.transact(57, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().clearPackagePreferredActivities(param1String);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public boolean compileLayouts(String param1String) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(106, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().compileLayouts(param1String);
          return bool;
        } 
        parcel2.readException();
        int i = parcel2.readInt();
    ...
    public String[] currentToCanonicalPackageNames(String[] param1ArrayOfString) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeStringArray(param1ArrayOfString);
        if (!this.mRemote.transact(7, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1ArrayOfString = IPackageManager.Stub.getDefaultImpl().currentToCanonicalPackageNames(param1ArrayOfString);
          return param1ArrayOfString;
        } 
        parcel2.readException();
        param1ArrayOfString = parcel2.createStringArray();
    ...
    public void deleteApplicationCacheFiles(String param1String, IPackageDataObserver param1IPackageDataObserver) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeStrongBinder(iBinder);
        if (!this.mRemote.transact(87, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().deleteApplicationCacheFiles(param1String, param1IPackageDataObserver);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void deleteApplicationCacheFilesAsUser(String param1String, int param1Int, IPackageDataObserver param1IPackageDataObserver) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeStrongBinder(iBinder);
        if (!this.mRemote.transact(88, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().deleteApplicationCacheFilesAsUser(param1String, param1Int, param1IPackageDataObserver);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void deleteExistingPackageAsUser(VersionedPackage param1VersionedPackage, IPackageDeleteObserver2 param1IPackageDeleteObserver2, int param1Int) throws RemoteException {
      ...
      try {
        ...
        if (param1IPackageDeleteObserver2 != null) {
          iBinder = param1IPackageDeleteObserver2.asBinder();
        } else {
          iBinder = null;
        } 
        parcel1.writeStrongBinder(iBinder);
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(49, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().deleteExistingPackageAsUser(param1VersionedPackage, param1IPackageDeleteObserver2, param1Int);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void deletePackageAsUser(String param1String, int param1Int1, IPackageDeleteObserver param1IPackageDeleteObserver, int param1Int2, int param1Int3) throws RemoteException {
      ...
      try {
        ...
        if (param1IPackageDeleteObserver != null) {
          iBinder = param1IPackageDeleteObserver.asBinder();
        } else {
          iBinder = null;
        } 
        parcel1.writeStrongBinder(iBinder);
        ...
        parcel1.writeInt(param1Int3);
        if (!this.mRemote.transact(47, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().deletePackageAsUser(param1String, param1Int1, param1IPackageDeleteObserver, param1Int2, param1Int3);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void deletePackageVersioned(VersionedPackage param1VersionedPackage, IPackageDeleteObserver2 param1IPackageDeleteObserver2, int param1Int1, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(48, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().deletePackageVersioned(param1VersionedPackage, param1IPackageDeleteObserver2, param1Int1, param1Int2);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void dumpProfiles(String param1String) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String);
        if (!this.mRemote.transact(107, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().dumpProfiles(param1String);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void extendVerificationTimeout(int param1Int1, int param1Int2, long param1Long) throws RemoteException {
      ...
      try {
        ...
        if (!this.mRemote.transact(120, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().extendVerificationTimeout(param1Int1, param1Int2, param1Long);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public ResolveInfo findPersistentPreferredActivity(Intent param1Intent, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(27, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().findPersistentPreferredActivity(param1Intent, param1Int); 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
          ResolveInfo resolveInfo = (ResolveInfo)ResolveInfo.CREATOR.createFromParcel(parcel2);
        } else {
    ...
    public void finishPackageInstall(int param1Int, boolean param1Boolean) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(bool);
        if (!this.mRemote.transact(44, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().finishPackageInstall(param1Int, param1Boolean);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void flushPackageRestrictionsAsUser(int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(83, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().flushPackageRestrictionsAsUser(param1Int);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void forceDexOpt(String param1String) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String);
        if (!this.mRemote.transact(108, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().forceDexOpt(param1String);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void freeStorage(String param1String, long param1Long, int param1Int, IntentSender param1IntentSender) throws RemoteException {
      ...
      try {
        ...
        if (!this.mRemote.transact(86, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().freeStorage(param1String, param1Long, param1Int, param1IntentSender);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void freeStorageAndNotify(String param1String, long param1Long, int param1Int, IPackageDataObserver param1IPackageDataObserver) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeStrongBinder(iBinder);
        if (!this.mRemote.transact(85, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().freeStorageAndNotify(param1String, param1Long, param1Int, param1IPackageDataObserver);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public ParceledListSlice getAllIntentFilters(String param1String) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String);
        if (!this.mRemote.transact(125, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getAllIntentFilters(param1String); 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
          ParceledListSlice parceledListSlice = (ParceledListSlice)ParceledListSlice.CREATOR.createFromParcel(parcel2);
        } else {
    ...
    public String[] getAppOpPermissionPackages(String param1String) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String);
        if (!this.mRemote.transact(184, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getAppOpPermissionPackages(param1String); 
        parcel2.readException();
        return parcel2.createStringArray();
      } finally {
        parcel2.recycle();
    ...
    public int getApplicationEnabledSetting(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(81, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1Int = IPackageManager.Stub.getDefaultImpl().getApplicationEnabledSetting(param1String, param1Int);
          return param1Int;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public boolean getApplicationHiddenSettingAsUser(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(132, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().getApplicationHiddenSettingAsUser(param1String, param1Int);
          return bool;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public boolean getBlockUninstallForUser(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(137, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().getBlockUninstallForUser(param1String, param1Int);
          return bool;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public ChangedPackages getChangedPackages(int param1Int1, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(152, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          changedPackages = IPackageManager.Stub.getDefaultImpl().getChangedPackages(param1Int1, param1Int2);
          return changedPackages;
        } 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
    ...
    public ParceledListSlice getDeclaredSharedLibraries(String param1String, int param1Int1, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(156, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getDeclaredSharedLibraries(param1String, param1Int1, param1Int2); 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
          ParceledListSlice parceledListSlice = (ParceledListSlice)ParceledListSlice.CREATOR.createFromParcel(parcel2);
        } else {
    ...
    public byte[] getDefaultAppsBackup(int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(70, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getDefaultAppsBackup(param1Int); 
        parcel2.readException();
        return parcel2.createByteArray();
      } finally {
        parcel2.recycle();
    ...
    public int getFlagsForUid(int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(23, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1Int = IPackageManager.Stub.getDefaultImpl().getFlagsForUid(param1Int);
          return param1Int;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public CharSequence getHarmfulAppWarning(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(165, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getHarmfulAppWarning(param1String, param1Int); 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
          CharSequence charSequence = (CharSequence)TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(parcel2);
        } else {
    ...
    public ComponentName getHomeActivities(List<ResolveInfo> param1List) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInterfaceToken("android.content.pm.IPackageManager");
        if (!this.mRemote.transact(74, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          componentName1 = IPackageManager.Stub.getDefaultImpl().getHomeActivities(param1List);
          return componentName1;
        } 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
    ...
    public int getInstallReason(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(154, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1Int = IPackageManager.Stub.getDefaultImpl().getInstallReason(param1String, param1Int);
          return param1Int;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public InstallSourceInfo getInstallSourceInfo(String param1String) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String);
        if (!this.mRemote.transact(51, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getInstallSourceInfo(param1String); 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
          InstallSourceInfo installSourceInfo = (InstallSourceInfo)InstallSourceInfo.CREATOR.createFromParcel(parcel2);
        } else {
        ...
        return (InstallSourceInfo)param1String;
      } finally {
        parcel2.recycle();
        parcel1.recycle();
      } 
    ...
    public ParceledListSlice getInstalledApplications(int param1Int1, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(37, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          parceledListSlice = IPackageManager.Stub.getDefaultImpl().getInstalledApplications(param1Int1, param1Int2);
          return parceledListSlice;
        } 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
    ...
    public List<ModuleInfo> getInstalledModules(int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(179, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getInstalledModules(param1Int); 
        parcel2.readException();
        return parcel2.createTypedArrayList(ModuleInfo.CREATOR);
      } finally {
        parcel2.recycle();
    ...
    public ParceledListSlice getInstalledPackages(int param1Int1, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(35, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          parceledListSlice = IPackageManager.Stub.getDefaultImpl().getInstalledPackages(param1Int1, param1Int2);
          return parceledListSlice;
        } 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
    ...
    public String getInstallerPackageName(String param1String) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String);
        if (!this.mRemote.transact(50, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1String = IPackageManager.Stub.getDefaultImpl().getInstallerPackageName(param1String);
          return param1String;
        } 
        parcel2.readException();
    ...
    public String getInstantAppAndroidId(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(162, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1String = IPackageManager.Stub.getDefaultImpl().getInstantAppAndroidId(param1String, param1Int);
          return param1String;
        } 
        parcel2.readException();
        param1String = parcel2.readString();
    ...
    public byte[] getInstantAppCookie(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(144, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getInstantAppCookie(param1String, param1Int); 
        parcel2.readException();
        return parcel2.createByteArray();
      } finally {
        parcel2.recycle();
    ...
    public Bitmap getInstantAppIcon(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(146, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getInstantAppIcon(param1String, param1Int); 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
          Bitmap bitmap = (Bitmap)Bitmap.CREATOR.createFromParcel(parcel2);
        } else {
    ...
    public ParceledListSlice getInstantApps(int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(143, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          parceledListSlice = IPackageManager.Stub.getDefaultImpl().getInstantApps(param1Int);
          return parceledListSlice;
        } 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
    ...
    public InstrumentationInfo getInstrumentationInfo(ComponentName param1ComponentName, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(42, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getInstrumentationInfo(param1ComponentName, param1Int); 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
          InstrumentationInfo instrumentationInfo = (InstrumentationInfo)InstrumentationInfo.CREATOR.createFromParcel(parcel2);
        } else {
        ...
        return (InstrumentationInfo)param1ComponentName;
      } finally {
        parcel2.recycle();
        parcel1.recycle();
      } 
    ...
    public byte[] getIntentFilterVerificationBackup(int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(72, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getIntentFilterVerificationBackup(param1Int); 
        parcel2.readException();
        return parcel2.createByteArray();
      } finally {
        parcel2.recycle();
    ...
    public ParceledListSlice getIntentFilterVerifications(String param1String) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String);
        if (!this.mRemote.transact(124, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getIntentFilterVerifications(param1String); 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
          ParceledListSlice parceledListSlice = (ParceledListSlice)ParceledListSlice.CREATOR.createFromParcel(parcel2);
        } else {
    ...
    public int getIntentVerificationStatus(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(122, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1Int = IPackageManager.Stub.getDefaultImpl().getIntentVerificationStatus(param1String, param1Int);
          return param1Int;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public KeySet getKeySetByAlias(String param1String1, String param1String2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String2);
        if (!this.mRemote.transact(138, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getKeySetByAlias(param1String1, param1String2); 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
          KeySet keySet = (KeySet)KeySet.CREATOR.createFromParcel(parcel2);
        } else {
    ...
    public ResolveInfo getLastChosenActivity(Intent param1Intent, String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(53, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getLastChosenActivity(param1Intent, param1String, param1Int); 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
          ResolveInfo resolveInfo = (ResolveInfo)ResolveInfo.CREATOR.createFromParcel(parcel2);
        } else {
    ...
    public List<String> getMimeGroup(String param1String1, String param1String2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String2);
        if (!this.mRemote.transact(193, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getMimeGroup(param1String1, param1String2); 
        parcel2.readException();
        return parcel2.createStringArrayList();
      } finally {
        parcel2.recycle();
    ...
    public ModuleInfo getModuleInfo(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(180, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getModuleInfo(param1String, param1Int); 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
          ModuleInfo moduleInfo = (ModuleInfo)ModuleInfo.CREATOR.createFromParcel(parcel2);
        } else {
        ...
        return (ModuleInfo)param1String;
      } finally {
        parcel2.recycle();
        parcel1.recycle();
      } 
    ...
    public int getMoveStatus(int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(111, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1Int = IPackageManager.Stub.getDefaultImpl().getMoveStatus(param1Int);
          return param1Int;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public String[] getNamesForUids(int[] param1ArrayOfint) throws RemoteException {
      ...
      try {
        ...
        if (!this.mRemote.transact(21, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getNamesForUids(param1ArrayOfint); 
        parcel2.readException();
        return parcel2.createStringArray();
      } finally {
        parcel2.recycle();
    ...
    public int[] getPackageGids(String param1String, int param1Int1, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(6, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getPackageGids(param1String, param1Int1, param1Int2); 
        parcel2.readException();
        return parcel2.createIntArray();
      } finally {
        parcel2.recycle();
    ...
    public PackageInfo getPackageInfoVersioned(VersionedPackage param1VersionedPackage, int param1Int1, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(4, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getPackageInfoVersioned(param1VersionedPackage, param1Int1, param1Int2); 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
          PackageInfo packageInfo = (PackageInfo)PackageInfo.CREATOR.createFromParcel(parcel2);
        } else {
          param1VersionedPackage = null;
        } 
        return (PackageInfo)param1VersionedPackage;
      } finally {
        parcel2.recycle();
        parcel1.recycle();
      } 
    ...
    public void getPackageSizeInfo(String param1String, int param1Int, IPackageStatsObserver param1IPackageStatsObserver) throws RemoteException {
      ...
      try {
        ...
        if (param1IPackageStatsObserver != null) {
          iBinder = param1IPackageStatsObserver.asBinder();
        } else {
          iBinder = null;
        } 
        parcel1.writeStrongBinder(iBinder);
        if (!this.mRemote.transact(91, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().getPackageSizeInfo(param1String, param1Int, param1IPackageStatsObserver);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public int getPackageUid(String param1String, int param1Int1, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(5, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1Int1 = IPackageManager.Stub.getDefaultImpl().getPackageUid(param1String, param1Int1, param1Int2);
          return param1Int1;
        } 
        parcel2.readException();
        param1Int1 = parcel2.readInt();
    ...
    public ParceledListSlice getPackagesHoldingPermissions(String[] param1ArrayOfString, int param1Int1, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(36, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getPackagesHoldingPermissions(param1ArrayOfString, param1Int1, param1Int2); 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
          ParceledListSlice parceledListSlice = (ParceledListSlice)ParceledListSlice.CREATOR.createFromParcel(parcel2);
        } else {
        ...
        return (ParceledListSlice)param1ArrayOfString;
      } finally {
        parcel2.recycle();
        parcel1.recycle();
      } 
    ...
    public ParceledListSlice getPersistentApplications(int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(38, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          parceledListSlice = IPackageManager.Stub.getDefaultImpl().getPersistentApplications(param1Int);
          return parceledListSlice;
        } 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
    ...
    public int getPreferredActivities(List<IntentFilter> param1List, List<ComponentName> param1List1, String param1String) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String);
        if (!this.mRemote.transact(58, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getPreferredActivities(param1List, param1List1, param1String); 
        parcel2.readException();
        int i = parcel2.readInt();
        parcel2.readTypedList(param1List, IntentFilter.CREATOR);
        parcel2.readTypedList(param1List1, ComponentName.CREATOR);
        return i;
      } finally {
        parcel2.recycle();
        parcel1.recycle();
    ...
    public byte[] getPreferredActivityBackup(int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(68, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getPreferredActivityBackup(param1Int); 
        parcel2.readException();
        return parcel2.createByteArray();
      } finally {
        parcel2.recycle();
    ...
    public int getPrivateFlagsForUid(int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(24, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1Int = IPackageManager.Stub.getDefaultImpl().getPrivateFlagsForUid(param1Int);
          return param1Int;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public int getRuntimePermissionsVersion(int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(181, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1Int = IPackageManager.Stub.getDefaultImpl().getRuntimePermissionsVersion(param1Int);
          return param1Int;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public ParceledListSlice getSharedLibraries(String param1String, int param1Int1, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(155, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getSharedLibraries(param1String, param1Int1, param1Int2); 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
          ParceledListSlice parceledListSlice = (ParceledListSlice)ParceledListSlice.CREATOR.createFromParcel(parcel2);
        } else {
    ...
    public KeySet getSigningKeySet(String param1String) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String);
        if (!this.mRemote.transact(139, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getSigningKeySet(param1String); 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
          KeySet keySet = (KeySet)KeySet.CREATOR.createFromParcel(parcel2);
        } else {
    ...
    public Bundle getSuspendedPackageAppExtras(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(67, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getSuspendedPackageAppExtras(param1String, param1Int); 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
          Bundle bundle = (Bundle)Bundle.CREATOR.createFromParcel(parcel2);
        } else {
    ...
    public int getUidForSharedUser(String param1String) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String);
        if (!this.mRemote.transact(22, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().getUidForSharedUser(param1String); 
        parcel2.readException();
        return parcel2.readInt();
      } finally {
        parcel2.recycle();
    ...
    public String[] getUnsuspendablePackagesForUser(String[] param1ArrayOfString, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(65, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1ArrayOfString = IPackageManager.Stub.getDefaultImpl().getUnsuspendablePackagesForUser(param1ArrayOfString, param1Int);
          return param1ArrayOfString;
        } 
        parcel2.readException();
        param1ArrayOfString = parcel2.createStringArray();
    ...
    public void grantImplicitAccess(int param1Int, String param1String) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String);
        if (!this.mRemote.transact(195, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().grantImplicitAccess(param1Int, param1String);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void grantRuntimePermission(String param1String1, String param1String2, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(190, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().grantRuntimePermission(param1String1, param1String2, param1Int);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public boolean hasSigningCertificate(String param1String, byte[] param1ArrayOfbyte, int param1Int) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(166, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().hasSigningCertificate(param1String, param1ArrayOfbyte, param1Int);
          return bool;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public boolean hasSystemFeature(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(94, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().hasSystemFeature(param1String, param1Int);
          return bool;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public boolean hasUidSigningCertificate(int param1Int1, byte[] param1ArrayOfbyte, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(167, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().hasUidSigningCertificate(param1Int1, param1ArrayOfbyte, param1Int2);
          return bool;
        } 
        parcel2.readException();
        param1Int1 = parcel2.readInt();
    ...
    public int installExistingPackageAsUser(String param1String, int param1Int1, int param1Int2, int param1Int3, List<String> param1List) throws RemoteException {
      ...
      try {
        ...
        if (!this.mRemote.transact(118, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1Int1 = IPackageManager.Stub.getDefaultImpl().installExistingPackageAsUser(param1String, param1Int1, param1Int2, param1Int3, param1List);
          return param1Int1;
        } 
        parcel2.readException();
        param1Int1 = parcel2.readInt();
    ...
    public boolean isAutoRevokeWhitelisted(String param1String) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(194, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().isAutoRevokeWhitelisted(param1String);
          return bool;
        } 
        parcel2.readException();
        int i = parcel2.readInt();
    ...
    public boolean isInstantApp(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(147, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().isInstantApp(param1String, param1Int);
          return bool;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public boolean isPackageAvailable(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(2, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().isPackageAvailable(param1String, param1Int);
          return bool;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public boolean isPackageDeviceAdminOnAnyUser(String param1String) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(153, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().isPackageDeviceAdminOnAnyUser(param1String);
          return bool;
        } 
        parcel2.readException();
        int i = parcel2.readInt();
    ...
    public boolean isPackageSignedByKeySet(String param1String, KeySet param1KeySet) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String);
        boolean bool = true;
        if (param1KeySet != null) {
          parcel1.writeInt(1);
          param1KeySet.writeToParcel(parcel1, 0);
        } else {
          parcel1.writeInt(0);
        } 
        if (!this.mRemote.transact(140, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().isPackageSignedByKeySet(param1String, param1KeySet);
          return bool;
        } 
        parcel2.readException();
        int i = parcel2.readInt();
    ...
    public boolean isPackageSignedByKeySetExactly(String param1String, KeySet param1KeySet) throws RemoteException {
      ...
      try {
        ...
        if (!this.mRemote.transact(141, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().isPackageSignedByKeySetExactly(param1String, param1KeySet);
          return bool;
        } 
        parcel2.readException();
        int i = parcel2.readInt();
    ...
    public boolean isPackageStateProtected(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(177, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().isPackageStateProtected(param1String, param1Int);
          return bool;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public boolean isPackageSuspendedForUser(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(66, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().isPackageSuspendedForUser(param1String, param1Int);
          return bool;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public boolean isProtectedBroadcast(String param1String) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(15, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().isProtectedBroadcast(param1String);
          return bool;
        } 
        parcel2.readException();
        int i = parcel2.readInt();
    ...
    public boolean isUidPrivileged(int param1Int) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(25, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().isUidPrivileged(param1Int);
          return bool;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public void logAppProcessStartIfNeeded(String param1String1, int param1Int1, String param1String2, String param1String3, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(82, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().logAppProcessStartIfNeeded(param1String1, param1Int1, param1String2, param1String3, param1Int2);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public int movePackage(String param1String1, String param1String2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String2);
        if (!this.mRemote.transact(114, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().movePackage(param1String1, param1String2); 
        parcel2.readException();
        return parcel2.readInt();
      } finally {
        parcel2.recycle();
    ...
    public int movePrimaryStorage(String param1String) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String);
        if (!this.mRemote.transact(115, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().movePrimaryStorage(param1String); 
        parcel2.readException();
        return parcel2.readInt();
      } finally {
        parcel2.recycle();
    ...
    public void notifyDexLoad(String param1String1, Map<String, String> param1Map, String param1String2) throws RemoteException {
      ...
      try {
        ...
        if (param1Map == null) {
          ...
          parcel.writeInt(param1Map.size());
          _$$Lambda$IPackageManager$Stub$Proxy$X2I1qlX4SiKMZSjDTNzS_nTibbo _$$Lambda$IPackageManager$Stub$Proxy$X2I1qlX4SiKMZSjDTNzS_nTibbo = new _$$Lambda$IPackageManager$Stub$Proxy$X2I1qlX4SiKMZSjDTNzS_nTibbo();
          this(parcel);
          param1Map.forEach(_$$Lambda$IPackageManager$Stub$Proxy$X2I1qlX4SiKMZSjDTNzS_nTibbo);
        } 
        parcel.writeString(param1String2);
        if (!this.mRemote.transact(102, parcel, null, 1) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().notifyDexLoad(param1String1, param1Map, param1String2);
          return;
        } 
        return;
      } finally {
    ...
    public void notifyPackageUse(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        if (!this.mRemote.transact(101, parcel, null, 1) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().notifyPackageUse(param1String, param1Int);
          return;
        } 
        return;
      } finally {
    ...
    public void notifyPackagesReplacedReceived(String[] param1ArrayOfString) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeStringArray(param1ArrayOfString);
        if (!this.mRemote.transact(183, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().notifyPackagesReplacedReceived(param1ArrayOfString);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void overrideLabelAndIcon(ComponentName param1ComponentName, String param1String, int param1Int1, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(76, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().overrideLabelAndIcon(param1ComponentName, param1String, param1Int1, param1Int2);
          return;
        } 
        parcel2.readException();
        return;
        ...
        try {
          ...
          try {
            ...
            try {
              ...
              try {
                if (!this.mRemote.transact(104, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
                  param1Boolean1 = IPackageManager.Stub.getDefaultImpl().performDexOptMode(param1String1, param1Boolean1, param1String2, param1Boolean2, param1Boolean3, param1String3);
                  parcel2.recycle();
                  parcel1.recycle();
    ...
    public boolean performDexOptSecondary(String param1String1, String param1String2, boolean param1Boolean) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(i);
        if (!this.mRemote.transact(105, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1Boolean = IPackageManager.Stub.getDefaultImpl().performDexOptSecondary(param1String1, param1String2, param1Boolean);
    ...
    public ParceledListSlice queryContentProviders(String param1String1, int param1Int1, int param1Int2, String param1String2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String2);
        if (!this.mRemote.transact(41, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().queryContentProviders(param1String1, param1Int1, param1Int2, param1String2); 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
          ParceledListSlice parceledListSlice = (ParceledListSlice)ParceledListSlice.CREATOR.createFromParcel(parcel2);
        } else {
    ...
    public ParceledListSlice queryInstrumentation(String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(43, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null)
          return IPackageManager.Stub.getDefaultImpl().queryInstrumentation(param1String, param1Int); 
        parcel2.readException();
        if (parcel2.readInt() != 0) {
          ParceledListSlice parceledListSlice = (ParceledListSlice)ParceledListSlice.CREATOR.createFromParcel(parcel2);
        } else {
    ...
    public ParceledListSlice queryIntentActivities(Intent param1Intent, String param1String, int param1Int1, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        return (ParceledListSlice)param1Intent;
      } finally {
        parcel2.recycle();
        parcel1.recycle();
      } 
        ...
        try {
          ...
          try {
            ...
            try {
              ...
              parcel1.writeInt(param1Int2);
              if (!this.mRemote.transact(30, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
                ParceledListSlice parceledListSlice = IPackageManager.Stub.getDefaultImpl().queryIntentActivityOptions(param1ComponentName, param1ArrayOfIntent, param1ArrayOfString, param1Intent, param1String, param1Int1, param1Int2);
                parcel2.recycle();
                parcel1.recycle();
                return parceledListSlice;
              } 
    ...
    public void querySyncProviders(List<String> param1List, List<ProviderInfo> param1List1) throws RemoteException {
      ...
      try {
        ...
        if (!this.mRemote.transact(40, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().querySyncProviders(param1List, param1List1);
          return;
        } 
        parcel2.readException();
        parcel2.readStringList(param1List);
        parcel2.readTypedList(param1List1, ProviderInfo.CREATOR);
        return;
      } finally {
        parcel2.recycle();
        parcel1.recycle();
    ...
    public void reconcileSecondaryDexFiles(String param1String) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String);
        if (!this.mRemote.transact(110, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().reconcileSecondaryDexFiles(param1String);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void registerDexModule(String param1String1, String param1String2, boolean param1Boolean, IDexModuleRegisterCallback param1IDexModuleRegisterCallback) throws RemoteException {
      ...
      try {
        ...
        if (param1IDexModuleRegisterCallback != null) {
          iBinder = param1IDexModuleRegisterCallback.asBinder();
        } else {
          iBinder = null;
        } 
        parcel.writeStrongBinder(iBinder);
        if (!this.mRemote.transact(103, parcel, null, 1) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().registerDexModule(param1String1, param1String2, param1Boolean, param1IDexModuleRegisterCallback);
          return;
        } 
        return;
      } finally {
    ...
    public void registerMoveCallback(IPackageMoveObserver param1IPackageMoveObserver) throws RemoteException {
      ...
      try {
        ...
        if (param1IPackageMoveObserver != null) {
          iBinder = param1IPackageMoveObserver.asBinder();
        } else {
          iBinder = null;
        } 
        parcel1.writeStrongBinder(iBinder);
        if (!this.mRemote.transact(112, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().registerMoveCallback(param1IPackageMoveObserver);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void removePermission(String param1String) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String);
        if (!this.mRemote.transact(188, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().removePermission(param1String);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void replacePreferredActivity(IntentFilter param1IntentFilter, int param1Int1, ComponentName[] param1ArrayOfComponentName, ComponentName param1ComponentName, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(56, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().replacePreferredActivity(param1IntentFilter, param1Int1, param1ArrayOfComponentName, param1ComponentName, param1Int2);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void resetApplicationPreferences(int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(52, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().resetApplicationPreferences(param1Int);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void restoreDefaultApps(byte[] param1ArrayOfbyte, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(71, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().restoreDefaultApps(param1ArrayOfbyte, param1Int);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void restoreIntentFilterVerification(byte[] param1ArrayOfbyte, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(73, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().restoreIntentFilterVerification(param1ArrayOfbyte, param1Int);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void restoreLabelAndIcon(ComponentName param1ComponentName, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(77, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().restoreLabelAndIcon(param1ComponentName, param1Int);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void restorePreferredActivities(byte[] param1ArrayOfbyte, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(69, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().restorePreferredActivities(param1ArrayOfbyte, param1Int);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public boolean runBackgroundDexoptJob(List<String> param1List) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(109, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().runBackgroundDexoptJob(param1List);
          return bool;
        } 
        parcel2.readException();
        int i = parcel2.readInt();
    ...
    public void setApplicationCategoryHint(String param1String1, int param1Int, String param1String2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String2);
        if (!this.mRemote.transact(46, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().setApplicationCategoryHint(param1String1, param1Int, param1String2);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void setApplicationEnabledSetting(String param1String1, int param1Int1, int param1Int2, int param1Int3, String param1String2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String2);
        if (!this.mRemote.transact(80, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().setApplicationEnabledSetting(param1String1, param1Int1, param1Int2, param1Int3, param1String2);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public boolean setApplicationHiddenSettingAsUser(String param1String, boolean param1Boolean, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(131, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1Boolean = IPackageManager.Stub.getDefaultImpl().setApplicationHiddenSettingAsUser(param1String, param1Boolean, param1Int);
          return param1Boolean;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public boolean setBlockUninstallForUser(String param1String, boolean param1Boolean, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(136, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1Boolean = IPackageManager.Stub.getDefaultImpl().setBlockUninstallForUser(param1String, param1Boolean, param1Int);
          return param1Boolean;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public String[] setDistractingPackageRestrictionsAsUser(String[] param1ArrayOfString, int param1Int1, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(63, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1ArrayOfString = IPackageManager.Stub.getDefaultImpl().setDistractingPackageRestrictionsAsUser(param1ArrayOfString, param1Int1, param1Int2);
          return param1ArrayOfString;
        } 
        parcel2.readException();
        param1ArrayOfString = parcel2.createStringArray();
    ...
    public void setHarmfulAppWarning(String param1String, CharSequence param1CharSequence, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(164, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().setHarmfulAppWarning(param1String, param1CharSequence, param1Int);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void setHomeActivity(ComponentName param1ComponentName, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(75, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().setHomeActivity(param1ComponentName, param1Int);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public boolean setInstallLocation(int param1Int) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(116, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().setInstallLocation(param1Int);
          return bool;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public void setInstallerPackageName(String param1String1, String param1String2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeString(param1String2);
        if (!this.mRemote.transact(45, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().setInstallerPackageName(param1String1, param1String2);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public boolean setInstantAppCookie(String param1String, byte[] param1ArrayOfbyte, int param1Int) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(145, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().setInstantAppCookie(param1String, param1ArrayOfbyte, param1Int);
          return bool;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
        ...
        try {
          ...
          try {
            ...
            try {
              ...
              if (!this.mRemote.transact(54, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
                IPackageManager.Stub.getDefaultImpl().setLastChosenActivity(param1Intent, param1String, param1Int1, param1IntentFilter, param1Int2, param1ComponentName);
                parcel2.recycle();
                parcel1.recycle();
                return;
              } 
    ...
    public void setMimeGroup(String param1String1, String param1String2, List<String> param1List) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeStringList(param1List);
        if (!this.mRemote.transact(192, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().setMimeGroup(param1String1, param1String2, param1List);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void setPackageStoppedState(String param1String, boolean param1Boolean, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(84, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().setPackageStoppedState(param1String, param1Boolean, param1Int);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public String[] setPackagesSuspendedAsUser(String[] param1ArrayOfString, boolean param1Boolean, PersistableBundle param1PersistableBundle1, PersistableBundle param1PersistableBundle2, SuspendDialogInfo param1SuspendDialogInfo, String param1String, int param1Int) throws RemoteException {
      ...
      try {
        ...
        try {
          ...
          parcel1.writeInt(bool);
          if (param1PersistableBundle1 != null) {
            parcel1.writeInt(1);
            param1PersistableBundle1.writeToParcel(parcel1, 0);
          } else {
            parcel1.writeInt(0);
          } 
          if (param1PersistableBundle2 != null) {
            parcel1.writeInt(1);
            param1PersistableBundle2.writeToParcel(parcel1, 0);
          } else {
            parcel1.writeInt(0);
          } 
          if (param1SuspendDialogInfo != null) {
            parcel1.writeInt(1);
            param1SuspendDialogInfo.writeToParcel(parcel1, 0);
          } else {
            parcel1.writeInt(0);
          } 
          try {
            ...
            parcel1.writeInt(param1Int);
            if (!this.mRemote.transact(64, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
              param1ArrayOfString = IPackageManager.Stub.getDefaultImpl().setPackagesSuspendedAsUser(param1ArrayOfString, param1Boolean, param1PersistableBundle1, param1PersistableBundle2, param1SuspendDialogInfo, param1String, param1Int);
              parcel2.recycle();
              parcel1.recycle();
              return param1ArrayOfString;
            } 
    ...
    public boolean setRequiredForSystemUser(String param1String, boolean param1Boolean) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(i);
        if (!this.mRemote.transact(148, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1Boolean = IPackageManager.Stub.getDefaultImpl().setRequiredForSystemUser(param1String, param1Boolean);
          return param1Boolean;
        } 
        parcel2.readException();
        int i = parcel2.readInt();
    ...
    public void setRuntimePermissionsVersion(int param1Int1, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(182, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().setRuntimePermissionsVersion(param1Int1, param1Int2);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void setSystemAppHiddenUntilInstalled(String param1String, boolean param1Boolean) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(bool);
        if (!this.mRemote.transact(133, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().setSystemAppHiddenUntilInstalled(param1String, param1Boolean);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public boolean setSystemAppInstallState(String param1String, boolean param1Boolean, int param1Int) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int);
        if (!this.mRemote.transact(134, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          param1Boolean = IPackageManager.Stub.getDefaultImpl().setSystemAppInstallState(param1String, param1Boolean, param1Int);
          return param1Boolean;
        } 
        parcel2.readException();
        param1Int = parcel2.readInt();
    ...
    public void setUpdateAvailable(String param1String, boolean param1Boolean) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(bool);
        if (!this.mRemote.transact(149, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().setUpdateAvailable(param1String, param1Boolean);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void unregisterMoveCallback(IPackageMoveObserver param1IPackageMoveObserver) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeStrongBinder(iBinder);
        if (!this.mRemote.transact(113, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().unregisterMoveCallback(param1IPackageMoveObserver);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public boolean updateIntentVerificationStatus(String param1String, int param1Int1, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        boolean bool = false;
        if (!iBinder.transact(123, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          bool = IPackageManager.Stub.getDefaultImpl().updateIntentVerificationStatus(param1String, param1Int1, param1Int2);
          return bool;
        } 
        parcel2.readException();
        param1Int1 = parcel2.readInt();
    ...
    public void verifyIntentFilter(int param1Int1, int param1Int2, List<String> param1List) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeStringList(param1List);
        if (!this.mRemote.transact(121, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().verifyIntentFilter(param1Int1, param1Int2, param1List);
          return;
        } 
        parcel2.readException();
        return;
    ...
    public void verifyPendingInstall(int param1Int1, int param1Int2) throws RemoteException {
      ...
      try {
        ...
        parcel1.writeInt(param1Int2);
        if (!this.mRemote.transact(119, parcel1, parcel2, 0) && IPackageManager.Stub.getDefaultImpl() != null) {
          IPackageManager.Stub.getDefaultImpl().verifyPendingInstall(param1Int1, param1Int2);
          return;
        } 
        parcel2.readException();
        return;
...
/* Location:              /home/chun/Desktop/temp/!/android/content/pm/IPackageManager.class
