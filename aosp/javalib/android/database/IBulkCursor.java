...
public interface IBulkCursor extends IInterface {
  ...
  CursorWindow getWindow(int paramInt) throws RemoteException;
  
  void onMove(int paramInt) throws RemoteException;
  
  int requery(IContentObserver paramIContentObserver) throws RemoteException;
  
  Bundle respond(Bundle paramBundle) throws RemoteException;
}


/* Location:              /home/chun/Desktop/temp/!/android/database/IBulkCursor.class
