...
public class Rectangle extends Quad {
  ...
  public static Rectangle fromCenterVerticalAxis(Point paramPoint1, Point paramPoint2, Point paramPoint3) {
    Point point = paramPoint2.scaledTo(paramPoint3.y / 2.0F);
    paramPoint2 = paramPoint2.rotated90(1).scaledTo(paramPoint3.x / 2.0F);
    return new Rectangle(paramPoint1.minus(paramPoint2).minus(point), paramPoint1.plus(paramPoint2).minus(point), paramPoint1.minus(paramPoint2).plus(point), paramPoint1.plus(paramPoint2).plus(point));
  }
  
  public static Rectangle fromRotatedRect(Point paramPoint1, Point paramPoint2, float paramFloat) {
    Point point1 = new Point(paramPoint1.x - paramPoint2.x / 2.0F, paramPoint1.y - paramPoint2.y / 2.0F);
    Point point2 = new Point(paramPoint1.x + paramPoint2.x / 2.0F, paramPoint1.y - paramPoint2.y / 2.0F);
    Point point3 = new Point(paramPoint1.x - paramPoint2.x / 2.0F, paramPoint1.y + paramPoint2.y / 2.0F);
    paramPoint2 = new Point(paramPoint1.x + paramPoint2.x / 2.0F, paramPoint1.y + paramPoint2.y / 2.0F);
    return new Rectangle(point1.rotatedAround(paramPoint1, paramFloat), point2.rotatedAround(paramPoint1, paramFloat), point3.rotatedAround(paramPoint1, paramFloat), paramPoint2.rotatedAround(paramPoint1, paramFloat));
  }
...
/* Location:              /home/chun/Desktop/temp/!/android/filterfw/geometry/Rectangle.class
