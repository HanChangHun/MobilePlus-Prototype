...
public class AutoFixFilter extends Filter {
  private static final int[] normal_cdf = new int[] { 
  ...
  private void createHistogramFrame(FilterContext paramFilterContext, int paramInt1, int paramInt2, int[] paramArrayOfint) {
    ...
    for (k = 0; k < 766; k++)
      arrayOfInt[k] = (int)(arrayOfInt[k] * 65535L / ((paramInt1 - j * 2) * (paramInt2 - i * 2))); 
  ...
  public void initProgram(FilterContext paramFilterContext, int paramInt) {
    if (paramInt == 3) {
      ...
      this.mShaderProgram = (Program)shaderProgram;
  ...
  protected void prepare(FilterContext paramFilterContext) {
    ...
    for (byte b = 0; b < 'Ѐ'; b++)
      arrayOfInt[b] = (int)(normal_cdf[b] * 65535L / 766L); 
  ...
  public void process(FilterContext paramFilterContext) {
    ...
    Frame frame4 = this.mHistFrame;
    Frame frame3 = this.mDensityFrame;
    this.mShaderProgram.process(new Frame[] { frame2, frame4, frame3 }, frame1);
...
/* Location:              /home/chun/Desktop/temp/!/android/filterpacks/imageproc/AutoFixFilter.class
