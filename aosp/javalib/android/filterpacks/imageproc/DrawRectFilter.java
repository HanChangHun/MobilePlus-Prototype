...
public class DrawRectFilter extends Filter {
  ...
  public void process(FilterContext paramFilterContext) {
    ...
    Quad quad = ((Quad)pullInput("box").getObjectValue()).scaled(2.0F).translated(-1.0F, -1.0F);
    GLFrame gLFrame = (GLFrame)paramFilterContext.getFrameManager().duplicateFrame(frame);
    gLFrame.focus();
    renderBox(quad);
    pushOutput("image", (Frame)gLFrame);
    gLFrame.release();
  }
...
/* Location:              /home/chun/Desktop/temp/!/android/filterpacks/imageproc/DrawRectFilter.class
