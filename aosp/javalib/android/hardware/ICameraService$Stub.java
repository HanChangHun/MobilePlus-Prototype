...
public abstract class Stub extends Binder implements ICameraService {
  ...
  public static ICameraService asInterface(IBinder paramIBinder) {
    if (paramIBinder == null)
      return null; 
    IInterface iInterface = paramIBinder.queryLocalInterface("android.hardware.ICameraService");
    return (iInterface != null && iInterface instanceof ICameraService) ? (ICameraService)iInterface : new Proxy(paramIBinder);
  }
  ...
  public static boolean setDefaultImpl(ICameraService paramICameraService) {
    if (Proxy.sDefaultImpl == null) {
      if (paramICameraService != null) {
        Proxy.sDefaultImpl = paramICameraService;
        return true;
      } 
      return false;
    } 
    ...
    if (paramInt1 != 1598968902) {
      ...
      switch (paramInt1) {
        ...
        case 18:
          ...
          notifyDeviceStateChange(paramParcel1.readLong());
          return true;
        case 17:
          paramParcel1.enforceInterface("android.hardware.ICameraService");
        ...
        case 16:
          ...
          if (paramParcel1.readInt() != 0)
            bool1 = true; 
          setTorchMode(str3, bool1, paramParcel1.readStrongBinder());
          paramParcel2.writeNoException();
          return true;
        case 15:
          paramParcel1.enforceInterface("android.hardware.ICameraService");
          bool = isHiddenPhysicalCamera(paramParcel1.readString());
          paramParcel2.writeNoException();
          paramParcel2.writeInt(bool);
          return true;
        case 14:
          paramParcel1.enforceInterface("android.hardware.ICameraService");
          bool = supportsCameraApi(paramParcel1.readString(), paramParcel1.readInt());
          paramParcel2.writeNoException();
          paramParcel2.writeInt(bool);
          return true;
        case 13:
          paramParcel1.enforceInterface("android.hardware.ICameraService");
          str2 = getLegacyParameters(paramParcel1.readInt());
          paramParcel2.writeNoException();
        ...
        case 12:
          ...
          if (vendorTagDescriptorCache != null) {
            ...
            vendorTagDescriptorCache.writeToParcel(paramParcel2, 1);
          } else {
        ...
        case 11:
          ...
          if (vendorTagDescriptor != null) {
            paramParcel2.writeInt(1);
            vendorTagDescriptor.writeToParcel(paramParcel2, 1);
          } else {
            paramParcel2.writeInt(0);
          } 
          return true;
        ...
        case 7:
          ...
          paramParcel2.writeNoException();
          paramParcel2.writeTypedArray((Parcelable[])arrayOfConcurrentCameraIdCombination, 1);
          return true;
        case 6:
          ...
          paramParcel2.writeNoException();
          paramParcel2.writeTypedArray((Parcelable[])arrayOfCameraStatus, 1);
          return true;
        case 5:
        ...
        case 2:
          ...
          if (cameraInfo != null) {
            paramParcel2.writeInt(1);
            cameraInfo.writeToParcel(paramParcel2, 1);
          } else {
            paramParcel2.writeInt(0);
          } 
          return true;
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/ICameraService$Stub.class
