...
public class SizeAreaComparator implements Comparator<Camera.Size> {
  public static Camera.Size findLargestByArea(List<Camera.Size> paramList) {
    ...
    return Collections.<Camera.Size>max(paramList, new SizeAreaComparator());
  }
  ...
  public int compare(Camera.Size paramSize1, Camera.Size paramSize2) {
    ...
    long l3 = paramSize1.height * l1;
    long l4 = paramSize2.height * l2;
    boolean bool = true;
    byte b = 1;
    if (l3 == l4) {
      if (l1 <= l2)
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/camera2/legacy/SizeAreaComparator.class
