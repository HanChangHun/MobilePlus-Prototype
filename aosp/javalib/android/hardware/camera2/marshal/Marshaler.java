...
public abstract class Marshaler<T> {
  ...
  protected Marshaler(MarshalQueryable<T> paramMarshalQueryable, TypeReference<T> paramTypeReference, int paramInt) {
    this.mTypeReference = (TypeReference<T>)Preconditions.checkNotNull(paramTypeReference, "typeReference must not be null");
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/camera2/marshal/Marshaler.class
