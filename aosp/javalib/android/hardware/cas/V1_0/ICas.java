...
public interface ICas extends IBase {
  ...
  static ICas asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.cas@1.0::ICas");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.cas@1.0::ICas");
        if (bool)
          return proxy; 
      } 
  ...
  int closeSession(ArrayList<Byte> paramArrayList) throws RemoteException;
  ...
  void openSession(openSessionCallback paramopenSessionCallback) throws RemoteException;
  
  void ping() throws RemoteException;
  
  int processEcm(ArrayList<Byte> paramArrayList1, ArrayList<Byte> paramArrayList2) throws RemoteException;
  
  int processEmm(ArrayList<Byte> paramArrayList) throws RemoteException;
  
  int provision(String paramString) throws RemoteException;
  
  int refreshEntitlements(int paramInt, ArrayList<Byte> paramArrayList) throws RemoteException;
  
  int release() throws RemoteException;
  
  int sendEvent(int paramInt1, int paramInt2, ArrayList<Byte> paramArrayList) throws RemoteException;
  
  void setHALInstrumentation() throws RemoteException;
  
  int setPrivateData(ArrayList<Byte> paramArrayList) throws RemoteException;
  
  int setSessionPrivateData(ArrayList<Byte> paramArrayList1, ArrayList<Byte> paramArrayList2) throws RemoteException;
  ...
  public static abstract class Stub extends HwBinder implements ICas {
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.cas@1.0::ICas".equals(param1String) ? this : null);
    }
  ...
  class null implements openSessionCallback {
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/cas/V1_0/ICas.class
