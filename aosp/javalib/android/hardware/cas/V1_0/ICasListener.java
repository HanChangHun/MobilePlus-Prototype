...
public interface ICasListener extends IBase {
  ...
  static ICasListener asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.cas@1.0::ICasListener");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.cas@1.0::ICasListener");
        if (bool)
          return proxy; 
      } 
  ...
  void onEvent(int paramInt1, int paramInt2, ArrayList<Byte> paramArrayList) throws RemoteException;
  ...
  public static abstract class Stub extends HwBinder implements ICasListener {
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.cas@1.0::ICasListener".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/cas/V1_0/ICasListener.class
