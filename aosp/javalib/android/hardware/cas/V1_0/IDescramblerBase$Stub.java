...
public abstract class Stub extends HwBinder implements IDescramblerBase {
  ...
  public void onTransact(int paramInt1, HwParcel paramHwParcel1, HwParcel paramHwParcel2, int paramInt2) throws RemoteException {
    ...
    arrayList.enforceInterface("android.hardware.cas@1.0::IDescramblerBase");
    paramInt1 = setMediaCasSession(arrayList.readInt8Vector());
    paramHwParcel2.writeStatus(0);
    paramHwParcel2.writeInt32(paramInt1);
    paramHwParcel2.send();
  }
  ...
  public IHwInterface queryLocalInterface(String paramString) {
    return (IHwInterface)("android.hardware.cas@1.0::IDescramblerBase".equals(paramString) ? this : null);
  }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/cas/V1_0/IDescramblerBase$Stub.class
