...
public interface IDescramblerBase extends IBase {
  ...
  static IDescramblerBase asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.cas@1.0::IDescramblerBase");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.cas@1.0::IDescramblerBase");
        if (bool)
          return proxy; 
      } 
  ...
  static IDescramblerBase castFrom(IHwInterface paramIHwInterface) {
    IDescramblerBase iDescramblerBase;
    if (paramIHwInterface == null) {
      paramIHwInterface = null;
    } else {
      iDescramblerBase = asInterface(paramIHwInterface.asBinder());
    } 
    return iDescramblerBase;
  }
  ...
  static IDescramblerBase getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.cas@1.0::IDescramblerBase", paramString));
  }
  
  static IDescramblerBase getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.cas@1.0::IDescramblerBase", paramString, paramBoolean));
  }
  
  static IDescramblerBase getService(boolean paramBoolean) throws RemoteException {
  ...
  boolean requiresSecureDecoderComponent(String paramString) throws RemoteException;
  
  void setHALInstrumentation() throws RemoteException;
  
  int setMediaCasSession(ArrayList<Byte> paramArrayList) throws RemoteException;
  ...
  public static final class Proxy implements IDescramblerBase {
    ...
    public int release() throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.cas@1.0::IDescramblerBase");
      HwParcel hwParcel = new HwParcel();
      try {
    ...
    public boolean requiresSecureDecoderComponent(String param1String) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.cas@1.0::IDescramblerBase");
    ...
    public int setMediaCasSession(ArrayList<Byte> param1ArrayList) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.cas@1.0::IDescramblerBase");
  ...
  public static abstract class Stub extends HwBinder implements IDescramblerBase {
    ...
    public void onTransact(int param1Int1, HwParcel param1HwParcel1, HwParcel param1HwParcel2, int param1Int2) throws RemoteException {
      ...
      if (param1Int1 != 1) {
        if (param1Int1 != 2) {
          ...
          arrayList.enforceInterface("android.hardware.cas@1.0::IDescramblerBase");
          param1Int1 = release();
          param1HwParcel2.writeStatus(0);
        ...
        arrayList.enforceInterface("android.hardware.cas@1.0::IDescramblerBase");
        boolean bool = requiresSecureDecoderComponent(arrayList.readString());
        param1HwParcel2.writeStatus(0);
        param1HwParcel2.writeBool(bool);
        param1HwParcel2.send();
      } 
      arrayList.enforceInterface("android.hardware.cas@1.0::IDescramblerBase");
      param1Int1 = setMediaCasSession(arrayList.readInt8Vector());
      param1HwParcel2.writeStatus(0);
      param1HwParcel2.writeInt32(param1Int1);
      param1HwParcel2.send();
    }
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.cas@1.0::IDescramblerBase".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/cas/V1_0/IDescramblerBase.class
