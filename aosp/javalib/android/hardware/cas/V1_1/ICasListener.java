...
public interface ICasListener extends ICasListener {
  ...
  static ICasListener asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.cas@1.1::ICasListener");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.cas@1.1::ICasListener");
        if (bool)
          return proxy; 
      } 
  ...
  static ICasListener getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.cas@1.1::ICasListener", paramString));
  }
  
  static ICasListener getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.cas@1.1::ICasListener", paramString, paramBoolean));
  }
  ...
  void onSessionEvent(ArrayList<Byte> paramArrayList1, int paramInt1, int paramInt2, ArrayList<Byte> paramArrayList2) throws RemoteException;
  ...
  public static abstract class Stub extends HwBinder implements ICasListener {
    ...
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(Arrays.asList(new String[] { "android.hardware.cas@1.1::ICasListener", "android.hardware.cas@1.0::ICasListener", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor() {
      return "android.hardware.cas@1.1::ICasListener";
    }
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.cas@1.1::ICasListener".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/cas/V1_1/ICasListener.class
