...
public abstract class Stub extends HwBinder implements ICas {
  ...
  public void onTransact(int paramInt1, HwParcel paramHwParcel1, final HwParcel _hidl_reply, int paramInt2) throws RemoteException {
    ...
    switch (paramInt1) {
      ...
      case 11:
        ...
        paramInt1 = sendSessionEvent(arrayList.readInt8Vector(), arrayList.readInt32(), arrayList.readInt32(), arrayList.readInt8Vector());
        _hidl_reply.writeStatus(0);
  ...
  public IHwInterface queryLocalInterface(String paramString) {
    return (IHwInterface)("android.hardware.cas@1.2::ICas".equals(paramString) ? this : null);
  }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/cas/V1_2/ICas$Stub.class
