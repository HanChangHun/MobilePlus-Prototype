...
public interface ICas extends ICas {
  ...
  static ICas asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.cas@1.2::ICas");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.cas@1.2::ICas");
        if (bool)
          return proxy; 
      } 
  ...
  static ICas getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.cas@1.2::ICas", paramString));
  }
  
  static ICas getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.cas@1.2::ICas", paramString, paramBoolean));
  }
  ...
  void openSession_1_2(int paramInt1, int paramInt2, openSession_1_2Callback paramopenSession_1_2Callback) throws RemoteException;
  ...
  public static final class Proxy implements ICas {
    ...
    public void openSession(android.hardware.cas.V1_0.ICas.openSessionCallback param1openSessionCallback) throws RemoteException {
      HwParcel hwParcel1 = new HwParcel();
    ...
    public void openSession_1_2(int param1Int1, int param1Int2, ICas.openSession_1_2Callback param1openSession_1_2Callback) throws RemoteException {
      HwParcel hwParcel1 = new HwParcel();
      hwParcel1.writeInterfaceToken("android.hardware.cas@1.2::ICas");
      hwParcel1.writeInt32(param1Int1);
      hwParcel1.writeInt32(param1Int2);
      HwParcel hwParcel2 = new HwParcel();
      try {
        this.mRemote.transact(12, hwParcel1, hwParcel2, 0);
        hwParcel2.verifySuccess();
        hwParcel1.releaseTemporaryStorage();
        param1openSession_1_2Callback.onValues(hwParcel2.readInt32(), hwParcel2.readInt8Vector());
        return;
      } finally {
        hwParcel2.release();
      } 
  ...
  public static abstract class Stub extends HwBinder implements ICas {
    ...
    public final ArrayList<byte[]> getHashChain() {
      byte[] arrayOfByte1 = { 
          -63, -86, 80, -115, 0, -74, 110, -43, -2, -17, 
          -22, 57, -113, -43, -19, -14, -113, -90, 81, -84, 
          -119, 119, 58, -38, -41, -33, -38, 78, 10, 115, 
          -87, 82 };
      byte[] arrayOfByte2 = { 
      ...
      byte[] arrayOfByte3 = { 
          ...
          -54, 76 };
      return (ArrayList)new ArrayList<>(Arrays.asList((byte[])new byte[][] { arrayOfByte1, arrayOfByte2, { 
    ...
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(Arrays.asList(new String[] { "android.hardware.cas@1.2::ICas", "android.hardware.cas@1.1::ICas", "android.hardware.cas@1.0::ICas", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor() {
      return "android.hardware.cas@1.2::ICas";
    }
    ...
    public void onTransact(int param1Int1, HwParcel param1HwParcel1, final HwParcel _hidl_reply, int param1Int2) throws RemoteException {
      ...
      switch (param1Int1) {
        default:
          ...
          _hidl_reply.send();
        case 12:
          arrayList.enforceInterface("android.hardware.cas@1.2::ICas");
          openSession_1_2(arrayList.readInt32(), arrayList.readInt32(), new ICas.openSession_1_2Callback() {
        ...
        case 2:
          arrayList.enforceInterface("android.hardware.cas@1.0::ICas");
          openSession(new android.hardware.cas.V1_0.ICas.openSessionCallback() {
                public void onValues(int param2Int, ArrayList<Byte> param2ArrayList) {
                  _hidl_reply.writeStatus(0);
                  _hidl_reply.writeInt32(param2Int);
                  _hidl_reply.writeInt8Vector(param2ArrayList);
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.cas@1.2::ICas".equals(param1String) ? this : null);
    }
  ...
  class null implements android.hardware.cas.V1_0.ICas.openSessionCallback {
  ...
  class null implements openSession_1_2Callback {
    public void onValues(int param1Int, ArrayList<Byte> param1ArrayList) {
      _hidl_reply.writeStatus(0);
      _hidl_reply.writeInt32(param1Int);
      _hidl_reply.writeInt8Vector(param1ArrayList);
  ...
  public static interface openSession_1_2Callback {
    void onValues(int param1Int, ArrayList<Byte> param1ArrayList);
  }
}


/* Location:              /home/chun/Desktop/temp/!/android/hardware/cas/V1_2/ICas.class
