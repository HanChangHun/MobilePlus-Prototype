...
public abstract class Stub extends HwBinder implements IMediaCasService {
  ...
  public void onTransact(int paramInt1, HwParcel paramHwParcel1, HwParcel paramHwParcel2, int paramInt2) throws RemoteException {
    ...
    switch (paramInt1) {
      default:
        switch (paramInt1) {
          ...
          case 256398152:
            ...
            while (paramInt1 < paramInt2) {
              long l = (paramInt1 * 32);
              arrayOfByte2 = arrayList3.get(paramInt1);
        ...
        paramHwParcel2.writeStatus(0);
        paramHwParcel2.writeStringVector(arrayList2);
        paramHwParcel2.send();
      case 6:
  ...
  public IHwInterface queryLocalInterface(String paramString) {
    return (IHwInterface)("android.hardware.cas@1.2::IMediaCasService".equals(paramString) ? this : null);
  }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/cas/V1_2/IMediaCasService$Stub.class
