...
public final class Proxy implements IContexthubCallback {
  ...
  public void handleAppAbort(long paramLong, int paramInt) throws RemoteException {
    null = new HwParcel();
  ...
  public void handleAppsInfo(ArrayList<HubAppInfo> paramArrayList) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.contexthub@1.0::IContexthubCallback");
    HubAppInfo.writeVectorToParcel(null, paramArrayList);
    HwParcel hwParcel = new HwParcel();
    try {
  ...
  public void handleClientMsg(ContextHubMsg paramContextHubMsg) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.contexthub@1.0::IContexthubCallback");
  ...
  public void handleHubEvent(int paramInt) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.contexthub@1.0::IContexthubCallback");
    null.writeInt32(paramInt);
    HwParcel hwParcel = new HwParcel();
  ...
  public void handleTxnResult(int paramInt1, int paramInt2) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.contexthub@1.0::IContexthubCallback");
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/contexthub/V1_0/IContexthubCallback$Proxy.class
