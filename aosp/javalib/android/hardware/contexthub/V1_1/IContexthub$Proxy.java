...
public final class Proxy implements IContexthub {
  ...
  public int disableNanoApp(int paramInt1, long paramLong, int paramInt2) throws RemoteException {
    null = new HwParcel();
  ...
  public int enableNanoApp(int paramInt1, long paramLong, int paramInt2) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.contexthub@1.0::IContexthub");
    null.writeInt32(paramInt1);
    null.writeInt64(paramLong);
  ...
  public int loadNanoApp(int paramInt1, NanoAppBinary paramNanoAppBinary, int paramInt2) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.contexthub@1.0::IContexthub");
    null.writeInt32(paramInt1);
    paramNanoAppBinary.writeToParcel(null);
    null.writeInt32(paramInt2);
    HwParcel hwParcel = new HwParcel();
    try {
  ...
  public void onSettingChanged(byte paramByte1, byte paramByte2) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.contexthub@1.1::IContexthub");
    null.writeInt8(paramByte1);
    null.writeInt8(paramByte2);
    HwParcel hwParcel = new HwParcel();
    try {
  ...
  public int queryApps(int paramInt) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.contexthub@1.0::IContexthub");
  ...
  public int registerCallback(int paramInt, IContexthubCallback paramIContexthubCallback) throws RemoteException {
    IHwBinder iHwBinder;
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.contexthub@1.0::IContexthub");
    null.writeInt32(paramInt);
    if (paramIContexthubCallback == null) {
      ...
      iHwBinder = paramIContexthubCallback.asBinder();
    } 
  ...
  public int sendMessageToHub(int paramInt, ContextHubMsg paramContextHubMsg) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.contexthub@1.0::IContexthub");
    null.writeInt32(paramInt);
    paramContextHubMsg.writeToParcel(null);
    HwParcel hwParcel = new HwParcel();
    try {
  ...
  public int unloadNanoApp(int paramInt1, long paramLong, int paramInt2) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.contexthub@1.0::IContexthub");
    null.writeInt32(paramInt1);
    null.writeInt64(paramLong);
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/contexthub/V1_1/IContexthub$Proxy.class
