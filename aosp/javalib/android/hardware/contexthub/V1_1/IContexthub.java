...
public interface IContexthub extends IContexthub {
  ...
  static IContexthub asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.contexthub@1.1::IContexthub");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.contexthub@1.1::IContexthub");
        if (bool)
          return proxy; 
      } 
  ...
  static IContexthub getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.contexthub@1.1::IContexthub", paramString));
  }
  
  static IContexthub getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.contexthub@1.1::IContexthub", paramString, paramBoolean));
  }
  ...
  void onSettingChanged(byte paramByte1, byte paramByte2) throws RemoteException;
  ...
  public static final class Proxy implements IContexthub {
    ...
    public void onSettingChanged(byte param1Byte1, byte param1Byte2) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.contexthub@1.1::IContexthub");
  ...
  public static abstract class Stub extends HwBinder implements IContexthub {
    ...
    public final ArrayList<byte[]> getHashChain() {
      return (ArrayList)new ArrayList<>(Arrays.asList((byte[])new byte[][] { { 
                -125, 81, -52, 1, -18, -44, -64, -76, 72, 45, 
                -107, 114, -75, -57, -35, -3, 23, -121, 77, -114, 
                -37, 81, -42, 118, 29, 52, -127, 22, -4, -111, 
                -35, 24 }, { 
    ...
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(Arrays.asList(new String[] { "android.hardware.contexthub@1.1::IContexthub", "android.hardware.contexthub@1.0::IContexthub", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor() {
      return "android.hardware.contexthub@1.1::IContexthub";
    }
    ...
    public void onTransact(int param1Int1, HwParcel param1HwParcel1, HwParcel param1HwParcel2, int param1Int2) throws RemoteException {
      ...
      switch (param1Int1) {
        default:
          ...
          param1HwParcel2.send();
        case 9:
          arrayList.enforceInterface("android.hardware.contexthub@1.1::IContexthub");
          onSettingChanged(arrayList.readInt8(), arrayList.readInt8());
          param1HwParcel2.writeStatus(0);
          param1HwParcel2.send();
        case 8:
      ...
      arrayList.enforceInterface("android.hardware.contexthub@1.0::IContexthub");
      ArrayList<String> arrayList = getHubs();
      param1HwParcel2.writeStatus(0);
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.contexthub@1.1::IContexthub".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/contexthub/V1_1/IContexthub.class
