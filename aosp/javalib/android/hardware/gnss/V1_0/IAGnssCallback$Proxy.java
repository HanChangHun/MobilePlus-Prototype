...
public final class Proxy implements IAGnssCallback {
  ...
  public void agnssStatusIpV4Cb(IAGnssCallback.AGnssStatusIpV4 paramAGnssStatusIpV4) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IAGnssCallback");
    paramAGnssStatusIpV4.writeToParcel(null);
  ...
  public void agnssStatusIpV6Cb(IAGnssCallback.AGnssStatusIpV6 paramAGnssStatusIpV6) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IAGnssCallback");
    paramAGnssStatusIpV6.writeToParcel(null);
    HwParcel hwParcel = new HwParcel();
    try {
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V1_0/IAGnssCallback$Proxy.class
