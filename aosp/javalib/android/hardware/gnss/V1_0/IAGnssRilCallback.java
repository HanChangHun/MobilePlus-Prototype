...
public interface IAGnssRilCallback extends IBase {
  ...
  static IAGnssRilCallback asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.gnss@1.0::IAGnssRilCallback");
    if (iHwInterface != null && iHwInterface instanceof IAGnssRilCallback)
      return (IAGnssRilCallback)iHwInterface; 
    Proxy proxy = new Proxy(paramIHwBinder);
    try {
      Iterator<String> iterator = proxy.interfaceChain().iterator();
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.gnss@1.0::IAGnssRilCallback");
        if (bool)
          return proxy; 
      } 
  ...
  static IAGnssRilCallback castFrom(IHwInterface paramIHwInterface) {
    IAGnssRilCallback iAGnssRilCallback;
    if (paramIHwInterface == null) {
      paramIHwInterface = null;
    } else {
      iAGnssRilCallback = asInterface(paramIHwInterface.asBinder());
    } 
    return iAGnssRilCallback;
  }
  ...
  static IAGnssRilCallback getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@1.0::IAGnssRilCallback", paramString));
  }
  
  static IAGnssRilCallback getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@1.0::IAGnssRilCallback", paramString, paramBoolean));
  }
  
  static IAGnssRilCallback getService(boolean paramBoolean) throws RemoteException {
  ...
  void requestSetIdCb(int paramInt) throws RemoteException;
  ...
  public static final class Proxy implements IAGnssRilCallback {
    ...
    public void requestRefLocCb() throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.gnss@1.0::IAGnssRilCallback");
      HwParcel hwParcel = new HwParcel();
      try {
    ...
    public void requestSetIdCb(int param1Int) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.gnss@1.0::IAGnssRilCallback");
  ...
  public static abstract class Stub extends HwBinder implements IAGnssRilCallback {
    ...
    public final ArrayList<byte[]> getHashChain() {
      return (ArrayList)new ArrayList<>(Arrays.asList((byte[])new byte[][] { { 
                47, -112, 119, 8, -41, 77, -108, -79, -31, 33, 
                -19, 39, 101, 28, -100, 114, -81, 101, -107, 45, 
                52, 123, 88, -1, 7, -38, -59, -43, -41, -89, 
                -10, 120 }, { 
    ...
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(Arrays.asList(new String[] { "android.hardware.gnss@1.0::IAGnssRilCallback", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor() {
      return "android.hardware.gnss@1.0::IAGnssRilCallback";
    }
    ...
    public void onTransact(int param1Int1, HwParcel param1HwParcel1, HwParcel param1HwParcel2, int param1Int2) throws RemoteException {
      ...
      if (param1Int1 != 1) {
        ...
        arrayList.enforceInterface("android.hardware.gnss@1.0::IAGnssRilCallback");
        requestRefLocCb();
        param1HwParcel2.writeStatus(0);
        param1HwParcel2.send();
      } 
      arrayList.enforceInterface("android.hardware.gnss@1.0::IAGnssRilCallback");
      requestSetIdCb(arrayList.readInt32());
      param1HwParcel2.writeStatus(0);
      param1HwParcel2.send();
    }
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.gnss@1.0::IAGnssRilCallback".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V1_0/IAGnssRilCallback.class
