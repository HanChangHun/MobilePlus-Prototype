...
public interface IGnssConfiguration extends IBase {
  ...
  static IGnssConfiguration asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.gnss@1.0::IGnssConfiguration");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.gnss@1.0::IGnssConfiguration");
        if (bool)
          return proxy; 
      } 
  ...
  static IGnssConfiguration getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@1.0::IGnssConfiguration", paramString));
  }
  
  static IGnssConfiguration getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@1.0::IGnssConfiguration", paramString, paramBoolean));
  }
  ...
  boolean setEmergencySuplPdn(boolean paramBoolean) throws RemoteException;
  
  boolean setGlonassPositioningProtocol(byte paramByte) throws RemoteException;
  
  boolean setGpsLock(byte paramByte) throws RemoteException;
  
  void setHALInstrumentation() throws RemoteException;
  
  boolean setLppProfile(byte paramByte) throws RemoteException;
  
  boolean setSuplEs(boolean paramBoolean) throws RemoteException;
  
  boolean setSuplMode(byte paramByte) throws RemoteException;
  
  boolean setSuplVersion(int paramInt) throws RemoteException;
  ...
  public static abstract class Stub extends HwBinder implements IGnssConfiguration {
    ...
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(Arrays.asList(new String[] { "android.hardware.gnss@1.0::IGnssConfiguration", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor() {
      return "android.hardware.gnss@1.0::IGnssConfiguration";
    }
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.gnss@1.0::IGnssConfiguration".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V1_0/IGnssConfiguration.class
