...
public final class Proxy implements IGnssGeofenceCallback {
  ...
  public void gnssGeofenceAddCb(int paramInt1, int paramInt2) throws RemoteException {
    null = new HwParcel();
  ...
  public void gnssGeofencePauseCb(int paramInt1, int paramInt2) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssGeofenceCallback");
    null.writeInt32(paramInt1);
    null.writeInt32(paramInt2);
  ...
  public void gnssGeofenceRemoveCb(int paramInt1, int paramInt2) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssGeofenceCallback");
    null.writeInt32(paramInt1);
    null.writeInt32(paramInt2);
  ...
  public void gnssGeofenceResumeCb(int paramInt1, int paramInt2) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssGeofenceCallback");
    null.writeInt32(paramInt1);
    null.writeInt32(paramInt2);
  ...
  public void gnssGeofenceStatusCb(int paramInt, GnssLocation paramGnssLocation) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssGeofenceCallback");
  ...
  public void gnssGeofenceTransitionCb(int paramInt1, GnssLocation paramGnssLocation, int paramInt2, long paramLong) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssGeofenceCallback");
    null.writeInt32(paramInt1);
    paramGnssLocation.writeToParcel(null);
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V1_0/IGnssGeofenceCallback$Proxy.class
