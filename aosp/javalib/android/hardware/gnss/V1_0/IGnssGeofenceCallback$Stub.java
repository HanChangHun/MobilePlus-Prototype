...
public abstract class Stub extends HwBinder implements IGnssGeofenceCallback {
  ...
  public void onTransact(int paramInt1, HwParcel paramHwParcel1, HwParcel paramHwParcel2, int paramInt2) throws RemoteException {
    ...
    switch (paramInt1) {
      ...
      case 2:
        ...
        gnssGeofenceStatusCb(paramInt1, gnssLocation);
        paramHwParcel2.writeStatus(0);
        paramHwParcel2.send();
      case 1:
        break;
    ...
    gnssLocation.readFromParcel((HwParcel)arrayList);
    gnssGeofenceTransitionCb(paramInt1, gnssLocation, arrayList.readInt32(), arrayList.readInt64());
    paramHwParcel2.writeStatus(0);
    paramHwParcel2.send();
  }
  ...
  public IHwInterface queryLocalInterface(String paramString) {
    return (IHwInterface)("android.hardware.gnss@1.0::IGnssGeofenceCallback".equals(paramString) ? this : null);
  }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V1_0/IGnssGeofenceCallback$Stub.class
