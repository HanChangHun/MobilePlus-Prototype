...
public interface IGnssMeasurement extends IBase {
  ...
  static IGnssMeasurement asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.gnss@1.0::IGnssMeasurement");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.gnss@1.0::IGnssMeasurement");
        if (bool)
          return proxy; 
      } 
  ...
  static IGnssMeasurement getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@1.0::IGnssMeasurement", paramString));
  }
  
  static IGnssMeasurement getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@1.0::IGnssMeasurement", paramString, paramBoolean));
  }
  ...
  int setCallback(IGnssMeasurementCallback paramIGnssMeasurementCallback) throws RemoteException;
  ...
  public static abstract class Stub extends HwBinder implements IGnssMeasurement {
    ...
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(Arrays.asList(new String[] { "android.hardware.gnss@1.0::IGnssMeasurement", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor() {
      return "android.hardware.gnss@1.0::IGnssMeasurement";
    }
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.gnss@1.0::IGnssMeasurement".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V1_0/IGnssMeasurement.class
