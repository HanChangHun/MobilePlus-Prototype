...
public final class Proxy implements IGnssNavigationMessage {
  ...
  public int setCallback(IGnssNavigationMessageCallback paramIGnssNavigationMessageCallback) throws RemoteException {
    IHwBinder iHwBinder;
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssNavigationMessage");
    if (paramIGnssNavigationMessageCallback == null) {
      paramIGnssNavigationMessageCallback = null;
    } else {
      iHwBinder = paramIGnssNavigationMessageCallback.asBinder();
    } 
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V1_0/IGnssNavigationMessage$Proxy.class
