...
public abstract class Stub extends HwBinder implements IGnssNavigationMessage {
  ...
  public void onTransact(int paramInt1, HwParcel paramHwParcel1, HwParcel paramHwParcel2, int paramInt2) throws RemoteException {
    ...
    arrayList.enforceInterface("android.hardware.gnss@1.0::IGnssNavigationMessage");
    paramInt1 = setCallback(IGnssNavigationMessageCallback.asInterface(arrayList.readStrongBinder()));
    paramHwParcel2.writeStatus(0);
  ...
  public IHwInterface queryLocalInterface(String paramString) {
    return (IHwInterface)("android.hardware.gnss@1.0::IGnssNavigationMessage".equals(paramString) ? this : null);
  }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V1_0/IGnssNavigationMessage$Stub.class
