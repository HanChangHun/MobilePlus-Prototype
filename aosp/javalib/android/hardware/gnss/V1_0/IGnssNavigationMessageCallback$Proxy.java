...
public final class Proxy implements IGnssNavigationMessageCallback {
  ...
  public void gnssNavigationMessageCb(IGnssNavigationMessageCallback.GnssNavigationMessage paramGnssNavigationMessage) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssNavigationMessageCallback");
    paramGnssNavigationMessage.writeToParcel(null);
    HwParcel hwParcel = new HwParcel();
    try {
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V1_0/IGnssNavigationMessageCallback$Proxy.class
