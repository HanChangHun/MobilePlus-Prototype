...
public final class Proxy implements IGnssNi {
  ...
  public void respond(int paramInt, byte paramByte) throws RemoteException {
    null = new HwParcel();
  ...
  public void setCallback(IGnssNiCallback paramIGnssNiCallback) throws RemoteException {
    IHwBinder iHwBinder;
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssNi");
    if (paramIGnssNiCallback == null) {
      paramIGnssNiCallback = null;
    } else {
      iHwBinder = paramIGnssNiCallback.asBinder();
    } 
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V1_0/IGnssNi$Proxy.class
