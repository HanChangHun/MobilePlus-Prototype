...
public interface IGnssNi extends IBase {
  ...
  static IGnssNi asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.gnss@1.0::IGnssNi");
    if (iHwInterface != null && iHwInterface instanceof IGnssNi)
      return (IGnssNi)iHwInterface; 
    Proxy proxy = new Proxy(paramIHwBinder);
    try {
      Iterator<String> iterator = proxy.interfaceChain().iterator();
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.gnss@1.0::IGnssNi");
        if (bool)
          return proxy; 
      } 
  ...
  static IGnssNi castFrom(IHwInterface paramIHwInterface) {
    IGnssNi iGnssNi;
    if (paramIHwInterface == null) {
      paramIHwInterface = null;
    } else {
      iGnssNi = asInterface(paramIHwInterface.asBinder());
    } 
    return iGnssNi;
  }
  ...
  static IGnssNi getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@1.0::IGnssNi", paramString));
  }
  
  static IGnssNi getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@1.0::IGnssNi", paramString, paramBoolean));
  }
  
  static IGnssNi getService(boolean paramBoolean) throws RemoteException {
  ...
  void respond(int paramInt, byte paramByte) throws RemoteException;
  
  void setCallback(IGnssNiCallback paramIGnssNiCallback) throws RemoteException;
  ...
  public static final class Proxy implements IGnssNi {
    ...
    public void respond(int param1Int, byte param1Byte) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssNi");
    ...
    public void setCallback(IGnssNiCallback param1IGnssNiCallback) throws RemoteException {
      IHwBinder iHwBinder;
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssNi");
      if (param1IGnssNiCallback == null) {
        param1IGnssNiCallback = null;
      } else {
        iHwBinder = param1IGnssNiCallback.asBinder();
      } 
  ...
  public static abstract class Stub extends HwBinder implements IGnssNi {
    ...
    public final ArrayList<byte[]> getHashChain() {
      return (ArrayList)new ArrayList<>(Arrays.asList((byte[])new byte[][] { { 
                36, -117, -49, 81, -38, 66, 115, -42, 79, 54, 
                123, -10, -121, 123, -82, -14, -2, -22, -54, 54, 
                84, 89, -124, 47, -45, -62, 20, -94, -36, 110, 
                2, 36 }, { 
    ...
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(Arrays.asList(new String[] { "android.hardware.gnss@1.0::IGnssNi", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor() {
      return "android.hardware.gnss@1.0::IGnssNi";
    }
    ...
    public void onTransact(int param1Int1, HwParcel param1HwParcel1, HwParcel param1HwParcel2, int param1Int2) throws RemoteException {
      ...
      if (param1Int1 != 1) {
        ...
        arrayList.enforceInterface("android.hardware.gnss@1.0::IGnssNi");
        respond(arrayList.readInt32(), arrayList.readInt8());
        param1HwParcel2.writeStatus(0);
        param1HwParcel2.send();
      } 
      arrayList.enforceInterface("android.hardware.gnss@1.0::IGnssNi");
      setCallback(IGnssNiCallback.asInterface(arrayList.readStrongBinder()));
      param1HwParcel2.writeStatus(0);
      param1HwParcel2.send();
    }
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.gnss@1.0::IGnssNi".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V1_0/IGnssNi.class
