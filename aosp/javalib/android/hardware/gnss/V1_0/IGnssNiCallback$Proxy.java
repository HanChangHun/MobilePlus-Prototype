...
public final class Proxy implements IGnssNiCallback {
  ...
  public void niNotifyCb(IGnssNiCallback.GnssNiNotification paramGnssNiNotification) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssNiCallback");
    paramGnssNiNotification.writeToParcel(null);
    HwParcel hwParcel = new HwParcel();
    try {
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V1_0/IGnssNiCallback$Proxy.class
