...
public final class Proxy implements IGnssXtra {
  ...
  public boolean injectXtraData(String paramString) throws RemoteException {
    null = new HwParcel();
  ...
  public boolean setCallback(IGnssXtraCallback paramIGnssXtraCallback) throws RemoteException {
    IHwBinder iHwBinder;
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssXtra");
    if (paramIGnssXtraCallback == null) {
      paramIGnssXtraCallback = null;
    } else {
      iHwBinder = paramIGnssXtraCallback.asBinder();
    } 
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V1_0/IGnssXtra$Proxy.class
