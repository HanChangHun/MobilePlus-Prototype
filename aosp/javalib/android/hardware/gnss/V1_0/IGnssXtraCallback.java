...
public interface IGnssXtraCallback extends IBase {
  ...
  static IGnssXtraCallback asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.gnss@1.0::IGnssXtraCallback");
    if (iHwInterface != null && iHwInterface instanceof IGnssXtraCallback)
      return (IGnssXtraCallback)iHwInterface; 
    Proxy proxy = new Proxy(paramIHwBinder);
    try {
      Iterator<String> iterator = proxy.interfaceChain().iterator();
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.gnss@1.0::IGnssXtraCallback");
        if (bool)
          return proxy; 
      } 
  ...
  static IGnssXtraCallback castFrom(IHwInterface paramIHwInterface) {
    IGnssXtraCallback iGnssXtraCallback;
    if (paramIHwInterface == null) {
      paramIHwInterface = null;
    } else {
      iGnssXtraCallback = asInterface(paramIHwInterface.asBinder());
    } 
    return iGnssXtraCallback;
  }
  ...
  static IGnssXtraCallback getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@1.0::IGnssXtraCallback", paramString));
  }
  
  static IGnssXtraCallback getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@1.0::IGnssXtraCallback", paramString, paramBoolean));
  }
  
  static IGnssXtraCallback getService(boolean paramBoolean) throws RemoteException {
  ...
  public static final class Proxy implements IGnssXtraCallback {
    ...
    public void downloadRequestCb() throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssXtraCallback");
  ...
  public static abstract class Stub extends HwBinder implements IGnssXtraCallback {
    ...
    public final ArrayList<byte[]> getHashChain() {
      ...
      return (ArrayList)new ArrayList<>(Arrays.asList((byte[])new byte[][] { { 
                -67, 54, 107, -125, -40, -43, 101, -48, -24, -65, 
                -85, -1, 58, -33, -54, -80, 37, -99, 117, -76, 
                -30, -87, -8, -31, -71, 30, 17, -47, 89, 58, 
                47, -5 }, arrayOfByte }));
    }
    
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(Arrays.asList(new String[] { "android.hardware.gnss@1.0::IGnssXtraCallback", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor() {
      return "android.hardware.gnss@1.0::IGnssXtraCallback";
    }
    ...
    public void onTransact(int param1Int1, HwParcel param1HwParcel1, HwParcel param1HwParcel2, int param1Int2) throws RemoteException {
      ...
      arrayList.enforceInterface("android.hardware.gnss@1.0::IGnssXtraCallback");
      downloadRequestCb();
      param1HwParcel2.writeStatus(0);
      param1HwParcel2.send();
    }
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.gnss@1.0::IGnssXtraCallback".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V1_0/IGnssXtraCallback.class
