...
public final class BlacklistedSource {
  ...
  public static final ArrayList<BlacklistedSource> readVectorFromParcel(HwParcel paramHwParcel) {
    ...
    for (byte b = 0; b < i; b++) {
      ...
      blacklistedSource.readEmbeddedFromParcel(paramHwParcel, hwBlob2, (b * 4));
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V1_1/IGnssConfiguration$BlacklistedSource.class
