...
public abstract class Stub extends HwBinder implements IAGnss {
      ...
      if (paramInt1 != 2) {
        if (paramInt1 != 3) {
          if (paramInt1 != 4) {
            ...
            paramHwParcel2.writeStatus(0);
            paramHwParcel2.writeBool(bool3);
            paramHwParcel2.send();
          } 
          arrayList.enforceInterface("android.hardware.gnss@2.0::IAGnss");
  ...
  public IHwInterface queryLocalInterface(String paramString) {
    return (IHwInterface)("android.hardware.gnss@2.0::IAGnss".equals(paramString) ? this : null);
  }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V2_0/IAGnss$Stub.class
