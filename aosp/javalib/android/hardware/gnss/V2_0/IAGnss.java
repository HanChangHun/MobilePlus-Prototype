...
public interface IAGnss extends IBase {
  ...
  static IAGnss asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.gnss@2.0::IAGnss");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.gnss@2.0::IAGnss");
        if (bool)
          return proxy; 
      } 
  ...
  static IAGnss getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@2.0::IAGnss", paramString));
  }
  
  static IAGnss getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@2.0::IAGnss", paramString, paramBoolean));
  }
  ...
  boolean dataConnOpen(long paramLong, String paramString, byte paramByte) throws RemoteException;
  ...
  public static final class Proxy implements IAGnss {
    ...
    public boolean dataConnClosed() throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.gnss@2.0::IAGnss");
    ...
    public boolean dataConnOpen(long param1Long, String param1String, byte param1Byte) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.gnss@2.0::IAGnss");
  ...
  public static abstract class Stub extends HwBinder implements IAGnss {
    ...
    public final ArrayList<byte[]> getHashChain() {
      return (ArrayList)new ArrayList<>(Arrays.asList((byte[])new byte[][] { { 
                Byte.MAX_VALUE, 70, 14, 121, 95, 93, 30, -43, -29, 120, 
                -109, 95, -104, -58, -37, 77, 57, 73, 125, -23, 
                -120, -82, -15, -76, -62, -92, -96, 122, 108, 64, 
                3, -110 }, { 
    ...
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(Arrays.asList(new String[] { "android.hardware.gnss@2.0::IAGnss", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor() {
      return "android.hardware.gnss@2.0::IAGnss";
    }
        ...
        if (param1Int1 != 2) {
          if (param1Int1 != 3) {
            if (param1Int1 != 4) {
              ...
              arrayList.enforceInterface("android.hardware.gnss@2.0::IAGnss");
              boolean bool3 = dataConnOpen(arrayList.readInt64(), arrayList.readString(), arrayList.readInt8());
              param1HwParcel2.writeStatus(0);
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.gnss@2.0::IAGnss".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V2_0/IAGnss.class
