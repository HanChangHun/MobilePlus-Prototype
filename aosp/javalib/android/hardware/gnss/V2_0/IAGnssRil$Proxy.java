...
public final class Proxy implements IAGnssRil {
  ...
  public void setCallback(IAGnssRilCallback paramIAGnssRilCallback) throws RemoteException {
    IHwBinder iHwBinder;
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IAGnssRil");
    if (paramIAGnssRilCallback == null) {
      paramIAGnssRilCallback = null;
    } else {
      iHwBinder = paramIAGnssRilCallback.asBinder();
    } 
  ...
  public void setRefLocation(IAGnssRil.AGnssRefLocation paramAGnssRefLocation) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IAGnssRil");
    paramAGnssRefLocation.writeToParcel(null);
    HwParcel hwParcel = new HwParcel();
    try {
  ...
  public boolean setSetId(byte paramByte, String paramString) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IAGnssRil");
  ...
  public boolean updateNetworkAvailability(boolean paramBoolean, String paramString) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IAGnssRil");
  ...
  public boolean updateNetworkState(boolean paramBoolean1, byte paramByte, boolean paramBoolean2) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IAGnssRil");
    ...
    try {
      ...
      hwParcel.verifySuccess();
      null.releaseTemporaryStorage();
      paramBoolean1 = hwParcel.readBool();
  ...
  public boolean updateNetworkState_2_0(IAGnssRil.NetworkAttributes paramNetworkAttributes) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@2.0::IAGnssRil");
    paramNetworkAttributes.writeToParcel(null);
    HwParcel hwParcel = new HwParcel();
    try {
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V2_0/IAGnssRil$Proxy.class
