...
import android.hardware.gnss.V1_1.IGnss;
...
public interface IGnss extends IGnss {
  ...
  static IGnss asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.gnss@2.0::IGnss");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.gnss@2.0::IGnss");
        if (bool)
          return proxy; 
      } 
  ...
  static IGnss getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@2.0::IGnss", paramString));
  }
  
  static IGnss getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@2.0::IGnss", paramString, paramBoolean));
  }
  ...
  boolean injectBestLocation_2_0(GnssLocation paramGnssLocation) throws RemoteException;
  ...
  boolean setCallback_2_0(IGnssCallback paramIGnssCallback) throws RemoteException;
  ...
  public static abstract class Stub extends HwBinder implements IGnss {
    ...
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(Arrays.asList(new String[] { "android.hardware.gnss@2.0::IGnss", "android.hardware.gnss@1.1::IGnss", "android.hardware.gnss@1.0::IGnss", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor() {
      return "android.hardware.gnss@2.0::IGnss";
    }
    ...
    public void onTransact(int param1Int1, HwParcel param1HwParcel1, HwParcel param1HwParcel2, int param1Int2) throws RemoteException {
      ...
      HwBlob hwBlob2 = null;
      IGnssMeasurement iGnssMeasurement4 = null;
      ...
      IGnssBatching iGnssBatching2 = null;
      ...
      switch (param1Int1) {
        ...
        case 29:
          ...
          if (iGnssMeasurement3 == null) {
            iGnssMeasurement3 = iGnssMeasurement4;
          } else {
        ...
        case 22:
          ...
          if (iGnssMeasurement2 == null) {
            iGnssMeasurement2 = iGnssMeasurement5;
          } else {
        ...
        case 13:
          ...
          if (iGnssMeasurement1 == null) {
            iGnssMeasurement1 = iGnssMeasurement6;
          } else {
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.gnss@2.0::IGnss".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V2_0/IGnss.class
