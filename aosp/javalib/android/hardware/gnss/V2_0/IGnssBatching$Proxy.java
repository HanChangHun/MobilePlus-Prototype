...
public final class Proxy implements IGnssBatching {
  ...
  public boolean init(IGnssBatchingCallback paramIGnssBatchingCallback) throws RemoteException {
    IHwBinder iHwBinder;
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssBatching");
    if (paramIGnssBatchingCallback == null) {
      paramIGnssBatchingCallback = null;
    } else {
      iHwBinder = paramIGnssBatchingCallback.asBinder();
    } 
  ...
  public boolean init_2_0(IGnssBatchingCallback paramIGnssBatchingCallback) throws RemoteException {
    IHwBinder iHwBinder;
    null = new HwParcel();
  ...
  public boolean start(IGnssBatching.Options paramOptions) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssBatching");
    paramOptions.writeToParcel(null);
    HwParcel hwParcel = new HwParcel();
    try {
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V2_0/IGnssBatching$Proxy.class
