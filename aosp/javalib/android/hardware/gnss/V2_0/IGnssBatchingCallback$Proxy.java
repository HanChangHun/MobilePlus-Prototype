...
public final class Proxy implements IGnssBatchingCallback {
  ...
  public void gnssLocationBatchCb(ArrayList<GnssLocation> paramArrayList) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@2.0::IGnssBatchingCallback");
    GnssLocation.writeVectorToParcel(null, paramArrayList);
    HwParcel hwParcel = new HwParcel();
    try {
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V2_0/IGnssBatchingCallback$Proxy.class
