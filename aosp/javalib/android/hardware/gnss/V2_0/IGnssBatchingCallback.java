...
public interface IGnssBatchingCallback extends IBase {
  ...
  static IGnssBatchingCallback asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.gnss@2.0::IGnssBatchingCallback");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.gnss@2.0::IGnssBatchingCallback");
        if (bool)
          return proxy; 
      } 
  ...
  static IGnssBatchingCallback getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@2.0::IGnssBatchingCallback", paramString));
  }
  
  static IGnssBatchingCallback getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@2.0::IGnssBatchingCallback", paramString, paramBoolean));
  }
  ...
  public static final class Proxy implements IGnssBatchingCallback {
    ...
    public void gnssLocationBatchCb(ArrayList<GnssLocation> param1ArrayList) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.gnss@2.0::IGnssBatchingCallback");
  ...
  public static abstract class Stub extends HwBinder implements IGnssBatchingCallback {
    ...
    public final ArrayList<byte[]> getHashChain() {
      return (ArrayList)new ArrayList<>(Arrays.asList((byte[])new byte[][] { { 
                31, -119, 57, 47, 30, -69, 105, 61, -113, -90, 
                -11, 3, 36, -79, 99, 95, -57, -97, -85, 36, 
                109, 49, -112, 14, 99, -103, -114, 27, 14, 23, 
                81, 28 }, { 
    ...
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(Arrays.asList(new String[] { "android.hardware.gnss@2.0::IGnssBatchingCallback", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor() {
      return "android.hardware.gnss@2.0::IGnssBatchingCallback";
    }
    ...
    public void onTransact(int param1Int1, HwParcel param1HwParcel1, HwParcel param1HwParcel2, int param1Int2) throws RemoteException {
      ...
      arrayList.enforceInterface("android.hardware.gnss@2.0::IGnssBatchingCallback");
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.gnss@2.0::IGnssBatchingCallback".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V2_0/IGnssBatchingCallback.class
