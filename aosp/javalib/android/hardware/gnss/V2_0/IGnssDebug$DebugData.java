...
public final class DebugData {
  ...
  public static final ArrayList<DebugData> readVectorFromParcel(HwParcel paramHwParcel) {
    ...
    for (byte b = 0; b < i; b++) {
      ...
      debugData.readEmbeddedFromParcel(paramHwParcel, hwBlob, (b * 112));
  ...
  public final void readEmbeddedFromParcel(HwParcel paramHwParcel, HwBlob paramHwBlob, long paramLong) {
    ...
    HwBlob hwBlob = paramHwParcel.readEmbeddedBuffer((i * 24), paramHwBlob.handle(), paramLong + 96L + 0L, true);
    this.satelliteDataArray.clear();
    for (byte b = 0; b < i; b++) {
      IGnssDebug.SatelliteData satelliteData = new IGnssDebug.SatelliteData();
      satelliteData.readEmbeddedFromParcel(paramHwParcel, hwBlob, (b * 24));
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V2_0/IGnssDebug$DebugData.class
