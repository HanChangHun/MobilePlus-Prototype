...
public interface IGnssMeasurement extends IGnssMeasurement {
  ...
  static IGnssMeasurement asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.gnss@2.0::IGnssMeasurement");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.gnss@2.0::IGnssMeasurement");
        if (bool)
          return proxy; 
      } 
  ...
  static IGnssMeasurement getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@2.0::IGnssMeasurement", paramString));
  }
  
  static IGnssMeasurement getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@2.0::IGnssMeasurement", paramString, paramBoolean));
  }
  ...
  int setCallback_2_0(IGnssMeasurementCallback paramIGnssMeasurementCallback, boolean paramBoolean) throws RemoteException;
  ...
  public static abstract class Stub extends HwBinder implements IGnssMeasurement {
    ...
    public final ArrayList<byte[]> getHashChain() {
      ...
      return (ArrayList)new ArrayList<>(Arrays.asList((byte[])new byte[][] { { 
                ...
                103, -92 }, arrayOfByte1, arrayOfByte2 }));
    }
    
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(Arrays.asList(new String[] { "android.hardware.gnss@2.0::IGnssMeasurement", "android.hardware.gnss@1.1::IGnssMeasurement", "android.hardware.gnss@1.0::IGnssMeasurement", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor() {
      return "android.hardware.gnss@2.0::IGnssMeasurement";
    }
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.gnss@2.0::IGnssMeasurement".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V2_0/IGnssMeasurement.class
