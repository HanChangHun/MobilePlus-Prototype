...
public final class GnssData {
  ...
  public static final ArrayList<GnssData> readVectorFromParcel(HwParcel paramHwParcel) {
    ...
    hwBlob = paramHwParcel.readEmbeddedBuffer((i * 112), hwBlob.handle(), 0L, true);
    arrayList.clear();
    for (byte b = 0; b < i; b++) {
      GnssData gnssData = new GnssData();
      gnssData.readEmbeddedFromParcel(paramHwParcel, hwBlob, (b * 112));
  ...
  public static final void writeVectorToParcel(HwParcel paramHwParcel, ArrayList<GnssData> paramArrayList) {
    ...
    for (byte b = 0; b < i; b++)
      ((GnssData)paramArrayList.get(b)).writeEmbeddedToBlob(hwBlob2, (b * 112)); 
  ...
  public final void readEmbeddedFromParcel(HwParcel paramHwParcel, HwBlob paramHwBlob, long paramLong) {
    ...
    HwBlob hwBlob = paramHwParcel.readEmbeddedBuffer((i * 176), paramHwBlob.handle(), paramLong + 0L + 0L, true);
    this.measurements.clear();
    for (byte b = 0; b < i; b++) {
      IGnssMeasurementCallback.GnssMeasurement gnssMeasurement = new IGnssMeasurementCallback.GnssMeasurement();
      gnssMeasurement.readEmbeddedFromParcel(paramHwParcel, hwBlob, (b * 176));
      this.measurements.add(gnssMeasurement);
    } 
    this.clock.readEmbeddedFromParcel(paramHwParcel, paramHwBlob, paramLong + 16L);
    this.elapsedRealtime.readEmbeddedFromParcel(paramHwParcel, paramHwBlob, paramLong + 88L);
  }
  ...
  public final void writeEmbeddedToBlob(HwBlob paramHwBlob, long paramLong) {
    ...
    this.elapsedRealtime.writeEmbeddedToBlob(paramHwBlob, 88L + paramLong);
  }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V2_0/IGnssMeasurementCallback$GnssData.class
