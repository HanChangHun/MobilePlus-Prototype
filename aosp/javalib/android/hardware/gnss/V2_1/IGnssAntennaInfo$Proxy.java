...
public final class Proxy implements IGnssAntennaInfo {
  ...
  public int setCallback(IGnssAntennaInfoCallback paramIGnssAntennaInfoCallback) throws RemoteException {
    IHwBinder iHwBinder;
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@2.1::IGnssAntennaInfo");
    if (paramIGnssAntennaInfoCallback == null) {
      paramIGnssAntennaInfoCallback = null;
    } else {
      iHwBinder = paramIGnssAntennaInfoCallback.asBinder();
    } 
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V2_1/IGnssAntennaInfo$Proxy.class
