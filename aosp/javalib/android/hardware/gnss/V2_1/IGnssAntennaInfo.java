...
public interface IGnssAntennaInfo extends IBase {
  ...
  static IGnssAntennaInfo asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.gnss@2.1::IGnssAntennaInfo");
    if (iHwInterface != null && iHwInterface instanceof IGnssAntennaInfo)
      return (IGnssAntennaInfo)iHwInterface; 
    Proxy proxy = new Proxy(paramIHwBinder);
    try {
      Iterator<String> iterator = proxy.interfaceChain().iterator();
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.gnss@2.1::IGnssAntennaInfo");
        if (bool)
          return proxy; 
      } 
  ...
  static IGnssAntennaInfo castFrom(IHwInterface paramIHwInterface) {
    IGnssAntennaInfo iGnssAntennaInfo;
    if (paramIHwInterface == null) {
      paramIHwInterface = null;
    } else {
      iGnssAntennaInfo = asInterface(paramIHwInterface.asBinder());
    } 
    return iGnssAntennaInfo;
  }
  ...
  static IGnssAntennaInfo getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@2.1::IGnssAntennaInfo", paramString));
  }
  
  static IGnssAntennaInfo getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@2.1::IGnssAntennaInfo", paramString, paramBoolean));
  }
  
  static IGnssAntennaInfo getService(boolean paramBoolean) throws RemoteException {
  ...
  int setCallback(IGnssAntennaInfoCallback paramIGnssAntennaInfoCallback) throws RemoteException;
  ...
  public static final class Proxy implements IGnssAntennaInfo {
    ...
    public void close() throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.gnss@2.1::IGnssAntennaInfo");
    ...
    public int setCallback(IGnssAntennaInfoCallback param1IGnssAntennaInfoCallback) throws RemoteException {
      IHwBinder iHwBinder;
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.gnss@2.1::IGnssAntennaInfo");
      if (param1IGnssAntennaInfoCallback == null) {
        param1IGnssAntennaInfoCallback = null;
      } else {
        iHwBinder = param1IGnssAntennaInfoCallback.asBinder();
      } 
  ...
  public static abstract class Stub extends HwBinder implements IGnssAntennaInfo {
    ...
    public void onTransact(int param1Int1, HwParcel param1HwParcel1, HwParcel param1HwParcel2, int param1Int2) throws RemoteException {
      ...
      arrayList.enforceInterface("android.hardware.gnss@2.1::IGnssAntennaInfo");
      param1Int1 = setCallback(IGnssAntennaInfoCallback.asInterface(arrayList.readStrongBinder()));
      param1HwParcel2.writeStatus(0);
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.gnss@2.1::IGnssAntennaInfo".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V2_1/IGnssAntennaInfo.class
