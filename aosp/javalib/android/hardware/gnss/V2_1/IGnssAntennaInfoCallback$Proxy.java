...
public final class Proxy implements IGnssAntennaInfoCallback {
  ...
  public void gnssAntennaInfoCb(ArrayList<IGnssAntennaInfoCallback.GnssAntennaInfo> paramArrayList) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@2.1::IGnssAntennaInfoCallback");
    IGnssAntennaInfoCallback.GnssAntennaInfo.writeVectorToParcel(null, paramArrayList);
    HwParcel hwParcel = new HwParcel();
    try {
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V2_1/IGnssAntennaInfoCallback$Proxy.class
