...
public final class Proxy implements IGnssCallback {
  ...
  public void gnssLocationCb_2_0(GnssLocation paramGnssLocation) throws RemoteException {
    null = new HwParcel();
  ...
  public void gnssRequestLocationCb_2_0(boolean paramBoolean1, boolean paramBoolean2) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@2.0::IGnssCallback");
  ...
  public void gnssSetCapabilitiesCb_2_0(int paramInt) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@2.0::IGnssCallback");
    null.writeInt32(paramInt);
    HwParcel hwParcel = new HwParcel();
  ...
  public void gnssSetCapabilitiesCb_2_1(int paramInt) throws RemoteException {
    null = new HwParcel();
  ...
  public void gnssSvStatusCb_2_0(ArrayList<IGnssCallback.GnssSvInfo> paramArrayList) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@2.0::IGnssCallback");
    IGnssCallback.GnssSvInfo.writeVectorToParcel(null, paramArrayList);
    HwParcel hwParcel = new HwParcel();
    try {
  ...
  public void gnssSvStatusCb_2_1(ArrayList<IGnssCallback.GnssSvInfo> paramArrayList) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@2.1::IGnssCallback");
    IGnssCallback.GnssSvInfo.writeVectorToParcel(null, paramArrayList);
    HwParcel hwParcel = new HwParcel();
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V2_1/IGnssCallback$Proxy.class
