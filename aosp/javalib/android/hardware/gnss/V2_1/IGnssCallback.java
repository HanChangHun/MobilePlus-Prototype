...
public interface IGnssCallback extends IGnssCallback {
  ...
  static IGnssCallback asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.gnss@2.1::IGnssCallback");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.gnss@2.1::IGnssCallback");
        if (bool)
          return proxy; 
      } 
  ...
  static IGnssCallback getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@2.1::IGnssCallback", paramString));
  }
  
  static IGnssCallback getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@2.1::IGnssCallback", paramString, paramBoolean));
  }
  ...
  void gnssSetCapabilitiesCb_2_1(int paramInt) throws RemoteException;
  
  void gnssSvStatusCb_2_1(ArrayList<GnssSvInfo> paramArrayList) throws RemoteException;
  ...
  public static final class GnssSvInfo {
    ...
    public static final ArrayList<GnssSvInfo> readVectorFromParcel(HwParcel param1HwParcel) {
      ...
      hwBlob = param1HwParcel.readEmbeddedBuffer((i * 40), hwBlob.handle(), 0L, true);
      arrayList.clear();
      for (byte b = 0; b < i; b++) {
        GnssSvInfo gnssSvInfo = new GnssSvInfo();
        gnssSvInfo.readEmbeddedFromParcel(param1HwParcel, hwBlob, (b * 40));
    ...
    public static final void writeVectorToParcel(HwParcel param1HwParcel, ArrayList<GnssSvInfo> param1ArrayList) {
      ...
      for (byte b = 0; b < i; b++)
        ((GnssSvInfo)param1ArrayList.get(b)).writeEmbeddedToBlob(hwBlob2, (b * 40)); 
    ...
    public final boolean equals(Object param1Object) {
      ...
      return !HidlSupport.deepEquals(this.v2_0, ((GnssSvInfo)param1Object).v2_0) ? false : (!(this.basebandCN0DbHz != ((GnssSvInfo)param1Object).basebandCN0DbHz));
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel param1HwParcel, HwBlob param1HwBlob, long param1Long) {
      ...
      this.basebandCN0DbHz = param1HwBlob.getDouble(32L + param1Long);
    }
    
    public final void readFromParcel(HwParcel param1HwParcel) {
      readEmbeddedFromParcel(param1HwParcel, param1HwParcel.readBuffer(40L), 0L);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob param1HwBlob, long param1Long) {
      ...
      param1HwBlob.putDouble(32L + param1Long, this.basebandCN0DbHz);
    }
  ...
  public static final class Proxy implements IGnssCallback {
    ...
    public void gnssSetCapabilitiesCb_2_1(int param1Int) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.gnss@2.1::IGnssCallback");
      null.writeInt32(param1Int);
      HwParcel hwParcel = new HwParcel();
      try {
    ...
    public void gnssSvStatusCb_2_1(ArrayList<IGnssCallback.GnssSvInfo> param1ArrayList) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.gnss@2.1::IGnssCallback");
      IGnssCallback.GnssSvInfo.writeVectorToParcel(null, param1ArrayList);
      HwParcel hwParcel = new HwParcel();
  ...
  public static abstract class Stub extends HwBinder implements IGnssCallback {
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.gnss@2.1::IGnssCallback".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V2_1/IGnssCallback.class
