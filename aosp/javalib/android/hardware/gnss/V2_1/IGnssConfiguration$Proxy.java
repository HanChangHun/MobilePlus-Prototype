...
public final class Proxy implements IGnssConfiguration {
  ...
  public boolean setBlacklist(ArrayList<IGnssConfiguration.BlacklistedSource> paramArrayList) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.1::IGnssConfiguration");
    IGnssConfiguration.BlacklistedSource.writeVectorToParcel(null, paramArrayList);
    HwParcel hwParcel = new HwParcel();
    try {
  ...
  public boolean setBlacklist_2_1(ArrayList<IGnssConfiguration.BlacklistedSource> paramArrayList) throws RemoteException {
    null = new HwParcel();
  ...
  public boolean setEmergencySuplPdn(boolean paramBoolean) throws RemoteException {
    null = new HwParcel();
  ...
  public boolean setEsExtensionSec(int paramInt) throws RemoteException {
    null = new HwParcel();
  ...
  public boolean setGlonassPositioningProtocol(byte paramByte) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssConfiguration");
  ...
  public boolean setGpsLock(byte paramByte) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssConfiguration");
    null.writeInt8(paramByte);
    HwParcel hwParcel = new HwParcel();
  ...
  public boolean setLppProfile(byte paramByte) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssConfiguration");
    null.writeInt8(paramByte);
    HwParcel hwParcel = new HwParcel();
  ...
  public boolean setSuplEs(boolean paramBoolean) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssConfiguration");
    null.writeBool(paramBoolean);
    HwParcel hwParcel = new HwParcel();
  ...
  public boolean setSuplMode(byte paramByte) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssConfiguration");
    null.writeInt8(paramByte);
    HwParcel hwParcel = new HwParcel();
  ...
  public boolean setSuplVersion(int paramInt) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssConfiguration");
    null.writeInt32(paramInt);
    HwParcel hwParcel = new HwParcel();
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V2_1/IGnssConfiguration$Proxy.class
