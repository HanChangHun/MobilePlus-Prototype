...
public interface IGnssConfiguration extends IGnssConfiguration {
  ...
  static IGnssConfiguration asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.gnss@2.1::IGnssConfiguration");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.gnss@2.1::IGnssConfiguration");
        if (bool)
          return proxy; 
      } 
  ...
  static IGnssConfiguration getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@2.1::IGnssConfiguration", paramString));
  }
  
  static IGnssConfiguration getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss@2.1::IGnssConfiguration", paramString, paramBoolean));
  }
  ...
  boolean setBlacklist_2_1(ArrayList<BlacklistedSource> paramArrayList) throws RemoteException;
  ...
  public static final class BlacklistedSource {
    ...
    public static final ArrayList<BlacklistedSource> readVectorFromParcel(HwParcel param1HwParcel) {
      ...
      hwBlob = param1HwParcel.readEmbeddedBuffer((i * 4), hwBlob.handle(), 0L, true);
      arrayList.clear();
      for (byte b = 0; b < i; b++) {
        BlacklistedSource blacklistedSource = new BlacklistedSource();
        blacklistedSource.readEmbeddedFromParcel(param1HwParcel, hwBlob, (b * 4));
  ...
  public static final class Proxy implements IGnssConfiguration {
    ...
    public boolean setBlacklist(ArrayList<android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource> param1ArrayList) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.gnss@1.1::IGnssConfiguration");
      android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource.writeVectorToParcel(null, param1ArrayList);
      HwParcel hwParcel = new HwParcel();
      try {
    ...
    public boolean setBlacklist_2_1(ArrayList<IGnssConfiguration.BlacklistedSource> param1ArrayList) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.gnss@2.1::IGnssConfiguration");
  ...
  public static abstract class Stub extends HwBinder implements IGnssConfiguration {
    ...
    public final ArrayList<byte[]> getHashChain() {
      byte[] arrayOfByte1 = { 
          115, 125, 117, 0, 23, 115, -113, 7, 83, -47, 
          59, -96, 26, 51, 16, -32, 22, 31, 41, 75, 
          -118, -24, 11, 63, -42, 62, -86, 34, 126, -99, 
          -100, 102 };
      byte[] arrayOfByte2 = { 
    ...
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(Arrays.asList(new String[] { "android.hardware.gnss@2.1::IGnssConfiguration", "android.hardware.gnss@2.0::IGnssConfiguration", "android.hardware.gnss@1.1::IGnssConfiguration", "android.hardware.gnss@1.0::IGnssConfiguration", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor() {
      return "android.hardware.gnss@2.1::IGnssConfiguration";
    }
    ...
    public void onTransact(int param1Int1, HwParcel param1HwParcel1, HwParcel param1HwParcel2, int param1Int2) throws RemoteException {
      ...
      switch (param1Int1) {
        default:
          ...
          param1HwParcel2.send();
        case 10:
          arrayList.enforceInterface("android.hardware.gnss@2.1::IGnssConfiguration");
          bool = setBlacklist_2_1(IGnssConfiguration.BlacklistedSource.readVectorFromParcel((HwParcel)arrayList));
          param1HwParcel2.writeStatus(0);
        ...
        case 8:
          ...
          bool = setBlacklist(android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource.readVectorFromParcel((HwParcel)arrayList));
          param1HwParcel2.writeStatus(0);
          param1HwParcel2.writeBool(bool);
          param1HwParcel2.send();
        case 7:
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.gnss@2.1::IGnssConfiguration".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V2_1/IGnssConfiguration.class
