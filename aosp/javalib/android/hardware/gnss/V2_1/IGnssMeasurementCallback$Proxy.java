...
public final class Proxy implements IGnssMeasurementCallback {
  ...
  public void GnssMeasurementCb(IGnssMeasurementCallback.GnssData paramGnssData) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss@1.0::IGnssMeasurementCallback");
    paramGnssData.writeToParcel(null);
  ...
  public void gnssMeasurementCb_2_0(IGnssMeasurementCallback.GnssData paramGnssData) throws RemoteException {
    null = new HwParcel();
  ...
  public void gnssMeasurementCb_2_1(IGnssMeasurementCallback.GnssData paramGnssData) throws RemoteException {
    null = new HwParcel();
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/V2_1/IGnssMeasurementCallback$Proxy.class
