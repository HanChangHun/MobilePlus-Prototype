...
public interface IMeasurementCorrections extends IBase {
  ...
  static IMeasurementCorrections asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.gnss.measurement_corrections@1.0::IMeasurementCorrections");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.gnss.measurement_corrections@1.0::IMeasurementCorrections");
        if (bool)
          return proxy; 
      } 
  ...
  static IMeasurementCorrections getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss.measurement_corrections@1.0::IMeasurementCorrections", paramString));
  }
  
  static IMeasurementCorrections getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss.measurement_corrections@1.0::IMeasurementCorrections", paramString, paramBoolean));
  }
  ...
  boolean setCallback(IMeasurementCorrectionsCallback paramIMeasurementCorrectionsCallback) throws RemoteException;
  
  boolean setCorrections(MeasurementCorrections paramMeasurementCorrections) throws RemoteException;
  ...
  public static abstract class Stub extends HwBinder implements IMeasurementCorrections {
    ...
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(Arrays.asList(new String[] { "android.hardware.gnss.measurement_corrections@1.0::IMeasurementCorrections", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor() {
      return "android.hardware.gnss.measurement_corrections@1.0::IMeasurementCorrections";
    }
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.gnss.measurement_corrections@1.0::IMeasurementCorrections".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/measurement_corrections/V1_0/IMeasurementCorrections.class
