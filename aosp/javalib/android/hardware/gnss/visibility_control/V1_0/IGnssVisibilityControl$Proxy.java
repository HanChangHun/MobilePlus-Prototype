...
public final class Proxy implements IGnssVisibilityControl {
  ...
  public boolean enableNfwLocationAccess(ArrayList<String> paramArrayList) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss.visibility_control@1.0::IGnssVisibilityControl");
    null.writeStringVector(paramArrayList);
  ...
  public boolean setCallback(IGnssVisibilityControlCallback paramIGnssVisibilityControlCallback) throws RemoteException {
    IHwBinder iHwBinder;
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss.visibility_control@1.0::IGnssVisibilityControl");
    if (paramIGnssVisibilityControlCallback == null) {
      paramIGnssVisibilityControlCallback = null;
    } else {
      iHwBinder = paramIGnssVisibilityControlCallback.asBinder();
    } 
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/visibility_control/V1_0/IGnssVisibilityControl$Proxy.class
