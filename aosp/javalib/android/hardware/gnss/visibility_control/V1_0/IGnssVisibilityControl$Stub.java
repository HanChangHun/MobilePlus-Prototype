...
public abstract class Stub extends HwBinder implements IGnssVisibilityControl {
  ...
  public final ArrayList<byte[]> getHashChain() {
    return (ArrayList)new ArrayList<>(Arrays.asList((byte[])new byte[][] { { 
              13, 39, -119, 86, -41, -4, 111, -33, -100, -87, 
              -60, 41, 98, -1, 45, 115, -106, 123, -69, 28, 
              -97, 11, 62, 11, 88, -41, 27, 112, -107, -62, 
              -122, -68 }, { 
  ...
  public final ArrayList<String> interfaceChain() {
    return new ArrayList<>(Arrays.asList(new String[] { "android.hardware.gnss.visibility_control@1.0::IGnssVisibilityControl", "android.hidl.base@1.0::IBase" }));
  }
  
  public final String interfaceDescriptor() {
    return "android.hardware.gnss.visibility_control@1.0::IGnssVisibilityControl";
  }
  ...
  public void onTransact(int paramInt1, HwParcel paramHwParcel1, HwParcel paramHwParcel2, int paramInt2) throws RemoteException {
    ...
    if (paramInt1 != 1) {
      ...
      arrayList.enforceInterface("android.hardware.gnss.visibility_control@1.0::IGnssVisibilityControl");
      boolean bool1 = setCallback(IGnssVisibilityControlCallback.asInterface(arrayList.readStrongBinder()));
      paramHwParcel2.writeStatus(0);
      paramHwParcel2.writeBool(bool1);
      paramHwParcel2.send();
    } 
    arrayList.enforceInterface("android.hardware.gnss.visibility_control@1.0::IGnssVisibilityControl");
    boolean bool = enableNfwLocationAccess(arrayList.readStringVector());
    paramHwParcel2.writeStatus(0);
  ...
  public IHwInterface queryLocalInterface(String paramString) {
    return (IHwInterface)("android.hardware.gnss.visibility_control@1.0::IGnssVisibilityControl".equals(paramString) ? this : null);
  }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/visibility_control/V1_0/IGnssVisibilityControl$Stub.class
