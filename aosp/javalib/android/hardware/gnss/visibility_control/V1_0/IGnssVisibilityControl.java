...
public interface IGnssVisibilityControl extends IBase {
  ...
  static IGnssVisibilityControl asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.gnss.visibility_control@1.0::IGnssVisibilityControl");
    if (iHwInterface != null && iHwInterface instanceof IGnssVisibilityControl)
      return (IGnssVisibilityControl)iHwInterface; 
    Proxy proxy = new Proxy(paramIHwBinder);
    try {
      Iterator<String> iterator = proxy.interfaceChain().iterator();
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.gnss.visibility_control@1.0::IGnssVisibilityControl");
        if (bool)
          return proxy; 
      } 
  ...
  static IGnssVisibilityControl castFrom(IHwInterface paramIHwInterface) {
    IGnssVisibilityControl iGnssVisibilityControl;
    if (paramIHwInterface == null) {
      paramIHwInterface = null;
    } else {
      iGnssVisibilityControl = asInterface(paramIHwInterface.asBinder());
    } 
    return iGnssVisibilityControl;
  }
  ...
  static IGnssVisibilityControl getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss.visibility_control@1.0::IGnssVisibilityControl", paramString));
  }
  
  static IGnssVisibilityControl getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.gnss.visibility_control@1.0::IGnssVisibilityControl", paramString, paramBoolean));
  }
  
  static IGnssVisibilityControl getService(boolean paramBoolean) throws RemoteException {
  ...
  boolean enableNfwLocationAccess(ArrayList<String> paramArrayList) throws RemoteException;
  ...
  boolean setCallback(IGnssVisibilityControlCallback paramIGnssVisibilityControlCallback) throws RemoteException;
  ...
  public static final class Proxy implements IGnssVisibilityControl {
    ...
    public boolean enableNfwLocationAccess(ArrayList<String> param1ArrayList) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.gnss.visibility_control@1.0::IGnssVisibilityControl");
      null.writeStringVector(param1ArrayList);
    ...
    public boolean setCallback(IGnssVisibilityControlCallback param1IGnssVisibilityControlCallback) throws RemoteException {
      IHwBinder iHwBinder;
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.gnss.visibility_control@1.0::IGnssVisibilityControl");
      if (param1IGnssVisibilityControlCallback == null) {
        param1IGnssVisibilityControlCallback = null;
      } else {
        iHwBinder = param1IGnssVisibilityControlCallback.asBinder();
      } 
  ...
  public static abstract class Stub extends HwBinder implements IGnssVisibilityControl {
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.gnss.visibility_control@1.0::IGnssVisibilityControl".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/visibility_control/V1_0/IGnssVisibilityControl.class
