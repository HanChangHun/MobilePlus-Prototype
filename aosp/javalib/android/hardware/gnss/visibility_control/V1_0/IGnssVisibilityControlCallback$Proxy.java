...
public final class Proxy implements IGnssVisibilityControlCallback {
  ...
  public void nfwNotifyCb(IGnssVisibilityControlCallback.NfwNotification paramNfwNotification) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.gnss.visibility_control@1.0::IGnssVisibilityControlCallback");
    paramNfwNotification.writeToParcel(null);
    HwParcel hwParcel = new HwParcel();
    try {
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/gnss/visibility_control/V1_0/IGnssVisibilityControlCallback$Proxy.class
