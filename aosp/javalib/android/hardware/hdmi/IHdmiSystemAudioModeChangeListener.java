...
public interface IHdmiSystemAudioModeChangeListener extends IInterface {
  ...
  public static abstract class Stub extends Binder implements IHdmiSystemAudioModeChangeListener {
    ...
    public static IHdmiSystemAudioModeChangeListener asInterface(IBinder param1IBinder) {
      ...
      return (iInterface != null && iInterface instanceof IHdmiSystemAudioModeChangeListener) ? (IHdmiSystemAudioModeChangeListener)iInterface : new Proxy(param1IBinder);
    }
  ...
  private static class Proxy implements IHdmiSystemAudioModeChangeListener {
    ...
    public void onStatusChanged(boolean param1Boolean) throws RemoteException {
      ...
      try {
        ...
        parcel.writeInt(bool);
        if (!this.mRemote.transact(1, parcel, null, 1) && IHdmiSystemAudioModeChangeListener.Stub.getDefaultImpl() != null) {
          IHdmiSystemAudioModeChangeListener.Stub.getDefaultImpl().onStatusChanged(param1Boolean);
          return;
        } 
        return;
      } finally {
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/hdmi/IHdmiSystemAudioModeChangeListener.class
