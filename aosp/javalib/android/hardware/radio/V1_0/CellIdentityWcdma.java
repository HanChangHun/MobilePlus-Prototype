...
public final class CellIdentityWcdma {
  ...
  public static final void writeVectorToParcel(HwParcel paramHwParcel, ArrayList<CellIdentityWcdma> paramArrayList) {
    ...
    for (byte b = 0; b < i; b++)
      ((CellIdentityWcdma)paramArrayList.get(b)).writeEmbeddedToBlob(hwBlob2, (b * 48)); 
  ...
  public final boolean equals(Object paramObject) {
    ...
    return !HidlSupport.deepEquals(this.mcc, ((CellIdentityWcdma)paramObject).mcc) ? false : (!HidlSupport.deepEquals(this.mnc, ((CellIdentityWcdma)paramObject).mnc) ? false : ((this.lac != ((CellIdentityWcdma)paramObject).lac) ? false : ((this.cid != ((CellIdentityWcdma)paramObject).cid) ? false : ((this.psc != ((CellIdentityWcdma)paramObject).psc) ? false : (!(this.uarfcn != ((CellIdentityWcdma)paramObject).uarfcn))))));
  }
  ...
  public final void readEmbeddedFromParcel(HwParcel paramHwParcel, HwBlob paramHwBlob, long paramLong) {
    ...
    this.psc = paramHwBlob.getInt32(paramLong + 40L);
    this.uarfcn = paramHwBlob.getInt32(paramLong + 44L);
  }
  ...
  public final void writeEmbeddedToBlob(HwBlob paramHwBlob, long paramLong) {
    ...
    paramHwBlob.putInt32(40L + paramLong, this.psc);
    paramHwBlob.putInt32(44L + paramLong, this.uarfcn);
  }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/radio/V1_0/CellIdentityWcdma.class
