...
public interface IRadio extends IBase {
  ...
  static IRadio asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.radio@1.0::IRadio");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.radio@1.0::IRadio");
        if (bool)
          return proxy; 
      } 
  ...
  void acceptCall(int paramInt) throws RemoteException;
  
  void acknowledgeIncomingGsmSmsWithPdu(int paramInt, boolean paramBoolean, String paramString) throws RemoteException;
  
  void acknowledgeLastIncomingCdmaSms(int paramInt, CdmaSmsAck paramCdmaSmsAck) throws RemoteException;
  
  void acknowledgeLastIncomingGsmSms(int paramInt1, boolean paramBoolean, int paramInt2) throws RemoteException;
  
  IHwBinder asBinder();
  
  void cancelPendingUssd(int paramInt) throws RemoteException;
  
  void changeIccPin2ForApp(int paramInt, String paramString1, String paramString2, String paramString3) throws RemoteException;
  
  void changeIccPinForApp(int paramInt, String paramString1, String paramString2, String paramString3) throws RemoteException;
  
  void conference(int paramInt) throws RemoteException;
  
  void deactivateDataCall(int paramInt1, int paramInt2, boolean paramBoolean) throws RemoteException;
  
  void debug(NativeHandle paramNativeHandle, ArrayList<String> paramArrayList) throws RemoteException;
  
  void deleteSmsOnRuim(int paramInt1, int paramInt2) throws RemoteException;
  
  void deleteSmsOnSim(int paramInt1, int paramInt2) throws RemoteException;
  
  void dial(int paramInt, Dial paramDial) throws RemoteException;
  
  void exitEmergencyCallbackMode(int paramInt) throws RemoteException;
  
  void explicitCallTransfer(int paramInt) throws RemoteException;
  
  void getAllowedCarriers(int paramInt) throws RemoteException;
  
  void getAvailableBandModes(int paramInt) throws RemoteException;
  
  void getAvailableNetworks(int paramInt) throws RemoteException;
  
  void getBasebandVersion(int paramInt) throws RemoteException;
  
  void getCDMASubscription(int paramInt) throws RemoteException;
  
  void getCallForwardStatus(int paramInt, CallForwardInfo paramCallForwardInfo) throws RemoteException;
  
  void getCallWaiting(int paramInt1, int paramInt2) throws RemoteException;
  
  void getCdmaBroadcastConfig(int paramInt) throws RemoteException;
  
  void getCdmaRoamingPreference(int paramInt) throws RemoteException;
  
  void getCdmaSubscriptionSource(int paramInt) throws RemoteException;
  
  void getCellInfoList(int paramInt) throws RemoteException;
  
  void getClip(int paramInt) throws RemoteException;
  
  void getClir(int paramInt) throws RemoteException;
  
  void getCurrentCalls(int paramInt) throws RemoteException;
  
  void getDataCallList(int paramInt) throws RemoteException;
  
  void getDataRegistrationState(int paramInt) throws RemoteException;
  
  DebugInfo getDebugInfo() throws RemoteException;
  
  void getDeviceIdentity(int paramInt) throws RemoteException;
  
  void getFacilityLockForApp(int paramInt1, String paramString1, String paramString2, int paramInt2, String paramString3) throws RemoteException;
  
  void getGsmBroadcastConfig(int paramInt) throws RemoteException;
  
  void getHardwareConfig(int paramInt) throws RemoteException;
  
  ArrayList<byte[]> getHashChain() throws RemoteException;
  
  void getIccCardStatus(int paramInt) throws RemoteException;
  
  void getImsRegistrationState(int paramInt) throws RemoteException;
  
  void getImsiForApp(int paramInt, String paramString) throws RemoteException;
  
  void getLastCallFailCause(int paramInt) throws RemoteException;
  
  void getModemActivityInfo(int paramInt) throws RemoteException;
  
  void getMute(int paramInt) throws RemoteException;
  
  void getNeighboringCids(int paramInt) throws RemoteException;
  
  void getNetworkSelectionMode(int paramInt) throws RemoteException;
  
  void getOperator(int paramInt) throws RemoteException;
  
  void getPreferredNetworkType(int paramInt) throws RemoteException;
  
  void getPreferredVoicePrivacy(int paramInt) throws RemoteException;
  
  void getRadioCapability(int paramInt) throws RemoteException;
  
  void getSignalStrength(int paramInt) throws RemoteException;
  
  void getSmscAddress(int paramInt) throws RemoteException;
  
  void getTTYMode(int paramInt) throws RemoteException;
  
  void getVoiceRadioTechnology(int paramInt) throws RemoteException;
  
  void getVoiceRegistrationState(int paramInt) throws RemoteException;
  
  void handleStkCallSetupRequestFromSim(int paramInt, boolean paramBoolean) throws RemoteException;
  
  void hangup(int paramInt1, int paramInt2) throws RemoteException;
  
  void hangupForegroundResumeBackground(int paramInt) throws RemoteException;
  
  void hangupWaitingOrBackground(int paramInt) throws RemoteException;
  
  void iccCloseLogicalChannel(int paramInt1, int paramInt2) throws RemoteException;
  
  void iccIOForApp(int paramInt, IccIo paramIccIo) throws RemoteException;
  
  void iccOpenLogicalChannel(int paramInt1, String paramString, int paramInt2) throws RemoteException;
  
  void iccTransmitApduBasicChannel(int paramInt, SimApdu paramSimApdu) throws RemoteException;
  
  void iccTransmitApduLogicalChannel(int paramInt, SimApdu paramSimApdu) throws RemoteException;
  ...
  void nvReadItem(int paramInt1, int paramInt2) throws RemoteException;
  
  void nvResetConfig(int paramInt1, int paramInt2) throws RemoteException;
  
  void nvWriteCdmaPrl(int paramInt, ArrayList<Byte> paramArrayList) throws RemoteException;
  
  void nvWriteItem(int paramInt, NvWriteItem paramNvWriteItem) throws RemoteException;
  
  void ping() throws RemoteException;
  
  void pullLceData(int paramInt) throws RemoteException;
  
  void rejectCall(int paramInt) throws RemoteException;
  
  void reportSmsMemoryStatus(int paramInt, boolean paramBoolean) throws RemoteException;
  
  void reportStkServiceIsRunning(int paramInt) throws RemoteException;
  
  void requestIccSimAuthentication(int paramInt1, int paramInt2, String paramString1, String paramString2) throws RemoteException;
  
  void requestIsimAuthentication(int paramInt, String paramString) throws RemoteException;
  
  void requestShutdown(int paramInt) throws RemoteException;
  
  void responseAcknowledgement() throws RemoteException;
  
  void sendBurstDtmf(int paramInt1, String paramString, int paramInt2, int paramInt3) throws RemoteException;
  
  void sendCDMAFeatureCode(int paramInt, String paramString) throws RemoteException;
  
  void sendCdmaSms(int paramInt, CdmaSmsMessage paramCdmaSmsMessage) throws RemoteException;
  
  void sendDeviceState(int paramInt1, int paramInt2, boolean paramBoolean) throws RemoteException;
  
  void sendDtmf(int paramInt, String paramString) throws RemoteException;
  
  void sendEnvelope(int paramInt, String paramString) throws RemoteException;
  
  void sendEnvelopeWithStatus(int paramInt, String paramString) throws RemoteException;
  
  void sendImsSms(int paramInt, ImsSmsMessage paramImsSmsMessage) throws RemoteException;
  
  void sendSMSExpectMore(int paramInt, GsmSmsMessage paramGsmSmsMessage) throws RemoteException;
  
  void sendSms(int paramInt, GsmSmsMessage paramGsmSmsMessage) throws RemoteException;
  
  void sendTerminalResponseToSim(int paramInt, String paramString) throws RemoteException;
  
  void sendUssd(int paramInt, String paramString) throws RemoteException;
  
  void separateConnection(int paramInt1, int paramInt2) throws RemoteException;
  
  void setAllowedCarriers(int paramInt, boolean paramBoolean, CarrierRestrictions paramCarrierRestrictions) throws RemoteException;
  
  void setBandMode(int paramInt1, int paramInt2) throws RemoteException;
  
  void setBarringPassword(int paramInt, String paramString1, String paramString2, String paramString3) throws RemoteException;
  
  void setCallForward(int paramInt, CallForwardInfo paramCallForwardInfo) throws RemoteException;
  
  void setCallWaiting(int paramInt1, boolean paramBoolean, int paramInt2) throws RemoteException;
  
  void setCdmaBroadcastActivation(int paramInt, boolean paramBoolean) throws RemoteException;
  
  void setCdmaBroadcastConfig(int paramInt, ArrayList<CdmaBroadcastSmsConfigInfo> paramArrayList) throws RemoteException;
  
  void setCdmaRoamingPreference(int paramInt1, int paramInt2) throws RemoteException;
  
  void setCdmaSubscriptionSource(int paramInt1, int paramInt2) throws RemoteException;
  
  void setCellInfoListRate(int paramInt1, int paramInt2) throws RemoteException;
  
  void setClir(int paramInt1, int paramInt2) throws RemoteException;
  
  void setDataAllowed(int paramInt, boolean paramBoolean) throws RemoteException;
  
  void setDataProfile(int paramInt, ArrayList<DataProfileInfo> paramArrayList, boolean paramBoolean) throws RemoteException;
  
  void setFacilityLockForApp(int paramInt1, String paramString1, boolean paramBoolean, String paramString2, int paramInt2, String paramString3) throws RemoteException;
  
  void setGsmBroadcastActivation(int paramInt, boolean paramBoolean) throws RemoteException;
  
  void setGsmBroadcastConfig(int paramInt, ArrayList<GsmBroadcastSmsConfigInfo> paramArrayList) throws RemoteException;
  
  void setHALInstrumentation() throws RemoteException;
  
  void setIndicationFilter(int paramInt1, int paramInt2) throws RemoteException;
  
  void setInitialAttachApn(int paramInt, DataProfileInfo paramDataProfileInfo, boolean paramBoolean1, boolean paramBoolean2) throws RemoteException;
  
  void setLocationUpdates(int paramInt, boolean paramBoolean) throws RemoteException;
  
  void setMute(int paramInt, boolean paramBoolean) throws RemoteException;
  
  void setNetworkSelectionModeAutomatic(int paramInt) throws RemoteException;
  
  void setNetworkSelectionModeManual(int paramInt, String paramString) throws RemoteException;
  
  void setPreferredNetworkType(int paramInt1, int paramInt2) throws RemoteException;
  
  void setPreferredVoicePrivacy(int paramInt, boolean paramBoolean) throws RemoteException;
  
  void setRadioCapability(int paramInt, RadioCapability paramRadioCapability) throws RemoteException;
  
  void setRadioPower(int paramInt, boolean paramBoolean) throws RemoteException;
  
  void setResponseFunctions(IRadioResponse paramIRadioResponse, IRadioIndication paramIRadioIndication) throws RemoteException;
  
  void setSimCardPower(int paramInt, boolean paramBoolean) throws RemoteException;
  
  void setSmscAddress(int paramInt, String paramString) throws RemoteException;
  
  void setSuppServiceNotifications(int paramInt, boolean paramBoolean) throws RemoteException;
  
  void setTTYMode(int paramInt1, int paramInt2) throws RemoteException;
  
  void setUiccSubscription(int paramInt, SelectUiccSub paramSelectUiccSub) throws RemoteException;
  
  void setupDataCall(int paramInt1, int paramInt2, DataProfileInfo paramDataProfileInfo, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3) throws RemoteException;
  
  void startDtmf(int paramInt, String paramString) throws RemoteException;
  
  void startLceService(int paramInt1, int paramInt2, boolean paramBoolean) throws RemoteException;
  
  void stopDtmf(int paramInt) throws RemoteException;
  
  void stopLceService(int paramInt) throws RemoteException;
  
  void supplyIccPin2ForApp(int paramInt, String paramString1, String paramString2) throws RemoteException;
  
  void supplyIccPinForApp(int paramInt, String paramString1, String paramString2) throws RemoteException;
  
  void supplyIccPuk2ForApp(int paramInt, String paramString1, String paramString2, String paramString3) throws RemoteException;
  
  void supplyIccPukForApp(int paramInt, String paramString1, String paramString2, String paramString3) throws RemoteException;
  
  void supplyNetworkDepersonalization(int paramInt, String paramString) throws RemoteException;
  
  void switchWaitingOrHoldingAndActive(int paramInt) throws RemoteException;
  
  boolean unlinkToDeath(IHwBinder.DeathRecipient paramDeathRecipient) throws RemoteException;
  
  void writeSmsToRuim(int paramInt, CdmaSmsWriteArgs paramCdmaSmsWriteArgs) throws RemoteException;
  
  void writeSmsToSim(int paramInt, SmsWriteArgs paramSmsWriteArgs) throws RemoteException;
  ...
  public static abstract class Stub extends HwBinder implements IRadio {
    ...
    public void onTransact(int param1Int1, HwParcel param1HwParcel1, HwParcel param1HwParcel2, int param1Int2) throws RemoteException {
      ...
      switch (param1Int1) {
        ...
        case 28:
          ...
          setupDataCall(param1Int1, param1Int2, dataProfileInfo1, arrayList.readBool(), arrayList.readBool(), arrayList.readBool());
        case 27:
          arrayList.enforceInterface("android.hardware.radio@1.0::IRadio");
          param1Int1 = arrayList.readInt32();
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.radio@1.0::IRadio".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/radio/V1_0/IRadio.class
