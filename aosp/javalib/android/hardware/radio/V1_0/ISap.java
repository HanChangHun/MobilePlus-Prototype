...
public interface ISap extends IBase {
  ...
  static ISap asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.radio@1.0::ISap");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.radio@1.0::ISap");
        if (bool)
          return proxy; 
      } 
  ...
  static ISap castFrom(IHwInterface paramIHwInterface) {
    ISap iSap;
    if (paramIHwInterface == null) {
      paramIHwInterface = null;
    } else {
      iSap = asInterface(paramIHwInterface.asBinder());
    } 
    return iSap;
  }
  ...
  static ISap getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.radio@1.0::ISap", paramString));
  }
  
  static ISap getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.radio@1.0::ISap", paramString, paramBoolean));
  }
  
  static ISap getService(boolean paramBoolean) throws RemoteException {
    return getService("default", paramBoolean);
  }
  
  void apduReq(int paramInt1, int paramInt2, ArrayList<Byte> paramArrayList) throws RemoteException;
  
  IHwBinder asBinder();
  
  void connectReq(int paramInt1, int paramInt2) throws RemoteException;
  
  void debug(NativeHandle paramNativeHandle, ArrayList<String> paramArrayList) throws RemoteException;
  
  void disconnectReq(int paramInt) throws RemoteException;
  ...
  void powerReq(int paramInt, boolean paramBoolean) throws RemoteException;
  
  void resetSimReq(int paramInt) throws RemoteException;
  
  void setCallback(ISapCallback paramISapCallback) throws RemoteException;
  
  void setHALInstrumentation() throws RemoteException;
  
  void setTransferProtocolReq(int paramInt1, int paramInt2) throws RemoteException;
  
  void transferAtrReq(int paramInt) throws RemoteException;
  
  void transferCardReaderStatusReq(int paramInt) throws RemoteException;
  ...
  public static final class Proxy implements ISap {
    ...
    public void apduReq(int param1Int1, int param1Int2, ArrayList<Byte> param1ArrayList) throws RemoteException {
      null = new HwParcel();
    ...
    public void connectReq(int param1Int1, int param1Int2) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.radio@1.0::ISap");
      null.writeInt32(param1Int1);
      null.writeInt32(param1Int2);
    ...
    public void disconnectReq(int param1Int) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.radio@1.0::ISap");
    ...
    public void powerReq(int param1Int, boolean param1Boolean) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.radio@1.0::ISap");
      null.writeInt32(param1Int);
    ...
    public void resetSimReq(int param1Int) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.radio@1.0::ISap");
      null.writeInt32(param1Int);
      HwParcel hwParcel = new HwParcel();
    ...
    public void setCallback(ISapCallback param1ISapCallback) throws RemoteException {
      IHwBinder iHwBinder;
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.radio@1.0::ISap");
      if (param1ISapCallback == null) {
        param1ISapCallback = null;
      } else {
        iHwBinder = param1ISapCallback.asBinder();
      } 
    ...
    public void setTransferProtocolReq(int param1Int1, int param1Int2) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.radio@1.0::ISap");
      null.writeInt32(param1Int1);
      null.writeInt32(param1Int2);
    ...
    public void transferAtrReq(int param1Int) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.radio@1.0::ISap");
      null.writeInt32(param1Int);
      HwParcel hwParcel = new HwParcel();
    ...
    public void transferCardReaderStatusReq(int param1Int) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.radio@1.0::ISap");
      null.writeInt32(param1Int);
      HwParcel hwParcel = new HwParcel();
  ...
  public static abstract class Stub extends HwBinder implements ISap {
    ...
    public final ArrayList<byte[]> getHashChain() {
      return (ArrayList)new ArrayList<>(Arrays.asList((byte[])new byte[][] { { 
                -34, 58, -71, -9, 59, 16, 115, -51, 103, 123, 
                25, -40, -122, -5, -110, 126, -109, -127, -77, 1, 
                97, -89, 4, 113, 45, 43, 48, -8, 117, -121, 
                63, 92 }, { 
    ...
    public void onTransact(int param1Int1, HwParcel param1HwParcel1, HwParcel param1HwParcel2, int param1Int2) throws RemoteException {
      ...
      switch (param1Int1) {
        default:
          ...
          param1HwParcel2.send();
        case 9:
          arrayList.enforceInterface("android.hardware.radio@1.0::ISap");
          setTransferProtocolReq(arrayList.readInt32(), arrayList.readInt32());
        case 8:
          arrayList.enforceInterface("android.hardware.radio@1.0::ISap");
          transferCardReaderStatusReq(arrayList.readInt32());
        case 7:
          arrayList.enforceInterface("android.hardware.radio@1.0::ISap");
          resetSimReq(arrayList.readInt32());
        case 6:
          arrayList.enforceInterface("android.hardware.radio@1.0::ISap");
          powerReq(arrayList.readInt32(), arrayList.readBool());
        case 5:
          arrayList.enforceInterface("android.hardware.radio@1.0::ISap");
          transferAtrReq(arrayList.readInt32());
        case 4:
          arrayList.enforceInterface("android.hardware.radio@1.0::ISap");
          apduReq(arrayList.readInt32(), arrayList.readInt32(), arrayList.readInt8Vector());
        case 3:
          arrayList.enforceInterface("android.hardware.radio@1.0::ISap");
          disconnectReq(arrayList.readInt32());
        case 2:
          arrayList.enforceInterface("android.hardware.radio@1.0::ISap");
          connectReq(arrayList.readInt32(), arrayList.readInt32());
        case 1:
          break;
      } 
      arrayList.enforceInterface("android.hardware.radio@1.0::ISap");
      setCallback(ISapCallback.asInterface(arrayList.readStrongBinder()));
      param1HwParcel2.writeStatus(0);
      param1HwParcel2.send();
    }
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.radio@1.0::ISap".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/radio/V1_0/ISap.class
