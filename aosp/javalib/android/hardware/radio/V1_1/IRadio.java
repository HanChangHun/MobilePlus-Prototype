...
public interface IRadio extends IRadio {
  ...
  static IRadio asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.radio@1.1::IRadio");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.radio@1.1::IRadio");
        if (bool)
          return proxy; 
      } 
  ...
  void setCarrierInfoForImsiEncryption(int paramInt, ImsiEncryptionInfo paramImsiEncryptionInfo) throws RemoteException;
  
  void setHALInstrumentation() throws RemoteException;
  
  void setSimCardPower_1_1(int paramInt1, int paramInt2) throws RemoteException;
  
  void startKeepalive(int paramInt, KeepaliveRequest paramKeepaliveRequest) throws RemoteException;
  
  void startNetworkScan(int paramInt, NetworkScanRequest paramNetworkScanRequest) throws RemoteException;
  
  void stopKeepalive(int paramInt1, int paramInt2) throws RemoteException;
  
  void stopNetworkScan(int paramInt) throws RemoteException;
  ...
  public static abstract class Stub extends HwBinder implements IRadio {
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.radio@1.1::IRadio".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/radio/V1_1/IRadio.class
