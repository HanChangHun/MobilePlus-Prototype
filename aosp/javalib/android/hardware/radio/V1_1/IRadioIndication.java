...
public interface IRadioIndication extends IRadioIndication {
  ...
  static IRadioIndication asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.radio@1.1::IRadioIndication");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.radio@1.1::IRadioIndication");
        if (bool)
          return proxy; 
      } 
  ...
  void carrierInfoForImsiEncryption(int paramInt) throws RemoteException;
  ...
  void keepaliveStatus(int paramInt, KeepaliveStatus paramKeepaliveStatus) throws RemoteException;
  
  boolean linkToDeath(IHwBinder.DeathRecipient paramDeathRecipient, long paramLong) throws RemoteException;
  
  void networkScanResult(int paramInt, NetworkScanResult paramNetworkScanResult) throws RemoteException;
  ...
  public static abstract class Stub extends HwBinder implements IRadioIndication {
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.radio@1.1::IRadioIndication".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/radio/V1_1/IRadioIndication.class
