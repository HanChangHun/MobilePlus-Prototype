...
public final class CellIdentity {
  ...
  public static final ArrayList<CellIdentity> readVectorFromParcel(HwParcel paramHwParcel) {
    ...
    for (byte b = 0; b < i; b++) {
      ...
      cellIdentity.readEmbeddedFromParcel(paramHwParcel, hwBlob2, (b * 88));
  ...
  public final void readEmbeddedFromParcel(HwParcel paramHwParcel, HwBlob paramHwBlob, long paramLong) {
    ...
    HwBlob hwBlob1 = paramHwParcel.readEmbeddedBuffer((i * 80), paramHwBlob.handle(), paramLong + 8L + 0L, true);
    this.cellIdentityGsm.clear();
    byte b;
    for (b = 0; b < i; b++) {
      CellIdentityGsm cellIdentityGsm = new CellIdentityGsm();
      cellIdentityGsm.readEmbeddedFromParcel(paramHwParcel, hwBlob1, (b * 80));
      this.cellIdentityGsm.add(cellIdentityGsm);
    } 
    i = paramHwBlob.getInt32(paramLong + 24L + 8L);
    hwBlob1 = paramHwParcel.readEmbeddedBuffer((i * 80), paramHwBlob.handle(), paramLong + 24L + 0L, true);
    this.cellIdentityWcdma.clear();
    for (b = 0; b < i; b++) {
      CellIdentityWcdma cellIdentityWcdma = new CellIdentityWcdma();
      cellIdentityWcdma.readEmbeddedFromParcel(paramHwParcel, hwBlob1, (b * 80));
      this.cellIdentityWcdma.add(cellIdentityWcdma);
    } 
    i = paramHwBlob.getInt32(paramLong + 40L + 8L);
    HwBlob hwBlob2 = paramHwParcel.readEmbeddedBuffer((i * 56), paramHwBlob.handle(), paramLong + 40L + 0L, true);
    ...
    hwBlob1 = paramHwParcel.readEmbeddedBuffer((i * 88), paramHwBlob.handle(), paramLong + 56L + 0L, true);
    this.cellIdentityLte.clear();
    for (b = 0; b < i; b++) {
      CellIdentityLte cellIdentityLte = new CellIdentityLte();
      cellIdentityLte.readEmbeddedFromParcel(paramHwParcel, hwBlob1, (b * 88));
      this.cellIdentityLte.add(cellIdentityLte);
    } 
    i = paramHwBlob.getInt32(paramLong + 72L + 8L);
    paramHwBlob = paramHwParcel.readEmbeddedBuffer((i * 88), paramHwBlob.handle(), paramLong + 72L + 0L, true);
    this.cellIdentityTdscdma.clear();
    for (b = 0; b < i; b++) {
      CellIdentityTdscdma cellIdentityTdscdma = new CellIdentityTdscdma();
      cellIdentityTdscdma.readEmbeddedFromParcel(paramHwParcel, paramHwBlob, (b * 88));
  ...
  public final void writeEmbeddedToBlob(HwBlob paramHwBlob, long paramLong) {
    ...
    HwBlob hwBlob = new HwBlob(i * 80);
    byte b;
    for (b = 0; b < i; b++)
      ((CellIdentityGsm)this.cellIdentityGsm.get(b)).writeEmbeddedToBlob(hwBlob, (b * 80)); 
    ...
    for (b = 0; b < i; b++)
      ((CellIdentityWcdma)this.cellIdentityWcdma.get(b)).writeEmbeddedToBlob(hwBlob, (b * 80)); 
    ...
    for (b = 0; b < i; b++)
      ((CellIdentityCdma)this.cellIdentityCdma.get(b)).writeEmbeddedToBlob(hwBlob, (b * 56)); 
    ...
    hwBlob = new HwBlob(i * 88);
    for (b = 0; b < i; b++)
      ((CellIdentityLte)this.cellIdentityLte.get(b)).writeEmbeddedToBlob(hwBlob, (b * 88)); 
    ...
    hwBlob = new HwBlob(i * 88);
    for (b = 0; b < i; b++)
      ((CellIdentityTdscdma)this.cellIdentityTdscdma.get(b)).writeEmbeddedToBlob(hwBlob, (b * 88)); 
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/radio/V1_2/CellIdentity.class
