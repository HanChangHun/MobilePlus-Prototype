...
public final class CellInfoGsm {
  ...
  public static final ArrayList<CellInfoGsm> readVectorFromParcel(HwParcel paramHwParcel) {
    ...
    for (byte b = 0; b < i; b++) {
      ...
      cellInfoGsm.readEmbeddedFromParcel(paramHwParcel, hwBlob, (b * 96));
  ...
  public static final void writeVectorToParcel(HwParcel paramHwParcel, ArrayList<CellInfoGsm> paramArrayList) {
    ...
    for (byte b = 0; b < i; b++)
      ((CellInfoGsm)paramArrayList.get(b)).writeEmbeddedToBlob(hwBlob2, (b * 96)); 
  ...
  public final void readEmbeddedFromParcel(HwParcel paramHwParcel, HwBlob paramHwBlob, long paramLong) {
    ...
    this.signalStrengthGsm.readEmbeddedFromParcel(paramHwParcel, paramHwBlob, 80L + paramLong);
  }
  ...
  public final void writeEmbeddedToBlob(HwBlob paramHwBlob, long paramLong) {
    ...
    this.signalStrengthGsm.writeEmbeddedToBlob(paramHwBlob, 80L + paramLong);
  }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/radio/V1_2/CellInfoGsm.class
