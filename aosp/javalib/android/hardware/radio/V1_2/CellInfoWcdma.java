...
public final class CellInfoWcdma {
  ...
  public static final ArrayList<CellInfoWcdma> readVectorFromParcel(HwParcel paramHwParcel) {
    ...
    HwBlob hwBlob2 = paramHwParcel.readEmbeddedBuffer((i * 96), hwBlob1.handle(), 0L, true);
    arrayList.clear();
    for (byte b = 0; b < i; b++) {
      CellInfoWcdma cellInfoWcdma = new CellInfoWcdma();
      cellInfoWcdma.readEmbeddedFromParcel(paramHwParcel, hwBlob2, (b * 96));
  ...
  public static final void writeVectorToParcel(HwParcel paramHwParcel, ArrayList<CellInfoWcdma> paramArrayList) {
    ...
    for (byte b = 0; b < i; b++)
      ((CellInfoWcdma)paramArrayList.get(b)).writeEmbeddedToBlob(hwBlob2, (b * 96)); 
  ...
  public final void readEmbeddedFromParcel(HwParcel paramHwParcel, HwBlob paramHwBlob, long paramLong) {
    ...
    this.signalStrengthWcdma.readEmbeddedFromParcel(paramHwParcel, paramHwBlob, 80L + paramLong);
  }
  ...
  public final void writeEmbeddedToBlob(HwBlob paramHwBlob, long paramLong) {
    ...
    this.signalStrengthWcdma.writeEmbeddedToBlob(paramHwBlob, 80L + paramLong);
  }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/radio/V1_2/CellInfoWcdma.class
