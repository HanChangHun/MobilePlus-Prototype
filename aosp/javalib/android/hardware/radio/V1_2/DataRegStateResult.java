...
public final class DataRegStateResult {
  ...
  public static final ArrayList<DataRegStateResult> readVectorFromParcel(HwParcel paramHwParcel) {
    ...
    HwBlob hwBlob2 = paramHwParcel.readEmbeddedBuffer((i * 104), hwBlob1.handle(), 0L, true);
    arrayList.clear();
    for (byte b = 0; b < i; b++) {
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/radio/V1_2/DataRegStateResult.class
