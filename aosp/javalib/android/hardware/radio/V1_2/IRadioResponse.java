...
public interface IRadioResponse extends IRadioResponse {
  ...
  static IRadioResponse asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.radio@1.2::IRadioResponse");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.radio@1.2::IRadioResponse");
        if (bool)
          return proxy; 
      } 
  ...
  void getCellInfoListResponse_1_2(RadioResponseInfo paramRadioResponseInfo, ArrayList<CellInfo> paramArrayList) throws RemoteException;
  
  void getCurrentCallsResponse_1_2(RadioResponseInfo paramRadioResponseInfo, ArrayList<Call> paramArrayList) throws RemoteException;
  
  void getDataRegistrationStateResponse_1_2(RadioResponseInfo paramRadioResponseInfo, DataRegStateResult paramDataRegStateResult) throws RemoteException;
  
  DebugInfo getDebugInfo() throws RemoteException;
  
  ArrayList<byte[]> getHashChain() throws RemoteException;
  
  void getIccCardStatusResponse_1_2(RadioResponseInfo paramRadioResponseInfo, CardStatus paramCardStatus) throws RemoteException;
  
  void getSignalStrengthResponse_1_2(RadioResponseInfo paramRadioResponseInfo, SignalStrength paramSignalStrength) throws RemoteException;
  
  void getVoiceRegistrationStateResponse_1_2(RadioResponseInfo paramRadioResponseInfo, VoiceRegStateResult paramVoiceRegStateResult) throws RemoteException;
  ...
  void setLinkCapacityReportingCriteriaResponse(RadioResponseInfo paramRadioResponseInfo) throws RemoteException;
  
  void setSignalStrengthReportingCriteriaResponse(RadioResponseInfo paramRadioResponseInfo) throws RemoteException;
  ...
  public static abstract class Stub extends HwBinder implements IRadioResponse {
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.radio@1.2::IRadioResponse".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/radio/V1_2/IRadioResponse.class
