...
import android.hardware.radio.V1_1.ISap;
...
public interface ISap extends ISap {
  ...
  static ISap asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.radio@1.2::ISap");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.radio@1.2::ISap");
        if (bool)
          return proxy; 
      } 
  ...
  public static abstract class Stub extends HwBinder implements ISap {
    ...
    public final ArrayList<byte[]> getHashChain() {
      return (ArrayList)new ArrayList<>(Arrays.asList((byte[])new byte[][] { { 
                45, -122, -110, -105, -108, 121, 94, 92, 112, -12, 
                -3, -75, 7, 52, -123, -3, 5, -125, 92, -100, 
                111, 73, 97, 22, 104, 124, 61, -97, 50, -26, 
                -33, 62 }, { 
                -7, 108, -68, 89, -33, -31, 108, -115, 12, 42, 
                126, 6, -37, 36, -40, 115, -118, 99, 40, -74, 
                -23, 15, 123, -114, 22, 64, -22, 43, 70, 0, 
                -34, -67 }, { 
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.radio@1.2::ISap".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/radio/V1_2/ISap.class
