...
public final class NetworkScanResult {
  ...
  public static final ArrayList<NetworkScanResult> readVectorFromParcel(HwParcel paramHwParcel) {
    ...
    for (byte b = 0; b < i; b++) {
      ...
      networkScanResult.readEmbeddedFromParcel(paramHwParcel, hwBlob, (b * 24));
  ...
  public final void readEmbeddedFromParcel(HwParcel paramHwParcel, HwBlob paramHwBlob, long paramLong) {
    ...
    for (byte b = 0; b < i; b++) {
      ...
      cellInfo.readEmbeddedFromParcel(paramHwParcel, paramHwBlob, (b * 112));
  ...
  public final void writeEmbeddedToBlob(HwBlob paramHwBlob, long paramLong) {
    ...
    HwBlob hwBlob = new HwBlob(i * 112);
    for (byte b = 0; b < i; b++)
      ((CellInfo)this.networkInfos.get(b)).writeEmbeddedToBlob(hwBlob, (b * 112)); 
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/radio/V1_2/NetworkScanResult.class
