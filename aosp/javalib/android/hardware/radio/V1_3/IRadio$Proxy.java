...
public final class Proxy implements IRadio {
  ...
  public void enableModem(int paramInt, boolean paramBoolean) throws RemoteException {
    null = new HwParcel();
  ...
  public void getModemStackStatus(int paramInt) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.radio@1.3::IRadio");
    null.writeInt32(paramInt);
    HwParcel hwParcel = new HwParcel();
  ...
  public void setSystemSelectionChannels(int paramInt, boolean paramBoolean, ArrayList<RadioAccessSpecifier> paramArrayList) throws RemoteException {
    null = new HwParcel();
    null.writeInterfaceToken("android.hardware.radio@1.3::IRadio");
    null.writeInt32(paramInt);
    null.writeBool(paramBoolean);
    RadioAccessSpecifier.writeVectorToParcel(null, paramArrayList);
    HwParcel hwParcel = new HwParcel();
    try {
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/radio/V1_3/IRadio$Proxy.class
