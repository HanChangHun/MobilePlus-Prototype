...
public abstract class Stub extends HwBinder implements IRadio {
  ...
  public void onTransact(int paramInt1, HwParcel paramHwParcel1, HwParcel paramHwParcel2, int paramInt2) throws RemoteException {
    ...
    switch (paramInt1) {
      ...
      case 141:
        ...
        setupDataCall_1_2(paramInt2, paramInt1, dataProfileInfo3, arrayList.readBool(), arrayList.readBool(), arrayList.readBool(), arrayList.readInt32(), arrayList.readStringVector(), arrayList.readStringVector());
      case 140:
        arrayList.enforceInterface("android.hardware.radio@1.2::IRadio");
      ...
      case 137:
        ...
        startNetworkScan_1_2(paramInt1, networkScanRequest1);
      case 136:
  ...
  public IHwInterface queryLocalInterface(String paramString) {
    return (IHwInterface)("android.hardware.radio@1.3::IRadio".equals(paramString) ? this : null);
  }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/radio/V1_3/IRadio$Stub.class
