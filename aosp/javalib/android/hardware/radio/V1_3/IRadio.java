...
public interface IRadio extends IRadio {
  ...
  static IRadio asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.radio@1.3::IRadio");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.radio@1.3::IRadio");
        if (bool)
          return proxy; 
      } 
  ...
  static IRadio getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.radio@1.3::IRadio", paramString));
  }
  
  static IRadio getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.radio@1.3::IRadio", paramString, paramBoolean));
  }
  ...
  void enableModem(int paramInt, boolean paramBoolean) throws RemoteException;
  
  DebugInfo getDebugInfo() throws RemoteException;
  
  ArrayList<byte[]> getHashChain() throws RemoteException;
  
  void getModemStackStatus(int paramInt) throws RemoteException;
  ...
  void setSystemSelectionChannels(int paramInt, boolean paramBoolean, ArrayList<RadioAccessSpecifier> paramArrayList) throws RemoteException;
  ...
  public static final class Proxy implements IRadio {
    ...
    public void enableModem(int param1Int, boolean param1Boolean) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.radio@1.3::IRadio");
      null.writeInt32(param1Int);
      null.writeBool(param1Boolean);
      HwParcel hwParcel = new HwParcel();
      try {
    ...
    public void getModemStackStatus(int param1Int) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.radio@1.3::IRadio");
      null.writeInt32(param1Int);
      HwParcel hwParcel = new HwParcel();
    ...
    public void setSystemSelectionChannels(int param1Int, boolean param1Boolean, ArrayList<RadioAccessSpecifier> param1ArrayList) throws RemoteException {
      null = new HwParcel();
      null.writeInterfaceToken("android.hardware.radio@1.3::IRadio");
      null.writeInt32(param1Int);
      null.writeBool(param1Boolean);
      RadioAccessSpecifier.writeVectorToParcel(null, param1ArrayList);
      HwParcel hwParcel = new HwParcel();
      try {
        this.mRemote.transact(143, null, hwParcel, 1);
        null.releaseTemporaryStorage();
        return;
      } finally {
        hwParcel.release();
  ...
  public static abstract class Stub extends HwBinder implements IRadio {
    ...
    public final ArrayList<byte[]> getHashChain() {
      ...
      return (ArrayList)new ArrayList<>(Arrays.asList((byte[])new byte[][] { { 
                -95, -58, -80, 118, 27, -53, -119, -42, -65, 21, 
                -95, 86, -7, 48, 107, Byte.MIN_VALUE, -112, -77, -87, 22, 
                -95, 95, -22, 22, -119, -76, -80, -63, 115, -114, 
                56, 47 }, arrayOfByte, { 
    ...
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(Arrays.asList(new String[] { "android.hardware.radio@1.3::IRadio", "android.hardware.radio@1.2::IRadio", "android.hardware.radio@1.1::IRadio", "android.hardware.radio@1.0::IRadio", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor() {
      return "android.hardware.radio@1.3::IRadio";
    }
    ...
    public void onTransact(int param1Int1, HwParcel param1HwParcel1, HwParcel param1HwParcel2, int param1Int2) throws RemoteException {
      ...
      switch (param1Int1) {
        default:
          ...
          param1HwParcel2.send();
        case 145:
          arrayList.enforceInterface("android.hardware.radio@1.3::IRadio");
          getModemStackStatus(arrayList.readInt32());
        case 144:
          arrayList.enforceInterface("android.hardware.radio@1.3::IRadio");
          enableModem(arrayList.readInt32(), arrayList.readBool());
        case 143:
          arrayList.enforceInterface("android.hardware.radio@1.3::IRadio");
          setSystemSelectionChannels(arrayList.readInt32(), arrayList.readBool(), RadioAccessSpecifier.readVectorFromParcel((HwParcel)arrayList));
        case 142:
        ...
        case 141:
          ...
          setupDataCall_1_2(param1Int2, param1Int1, dataProfileInfo3, arrayList.readBool(), arrayList.readBool(), arrayList.readBool(), arrayList.readInt32(), arrayList.readStringVector(), arrayList.readStringVector());
        case 140:
          arrayList.enforceInterface("android.hardware.radio@1.2::IRadio");
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.radio@1.3::IRadio".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/radio/V1_3/IRadio.class
