...
public interface IRadioIndication extends IRadioIndication {
  ...
  static IRadioIndication asInterface(IHwBinder paramIHwBinder) {
    if (paramIHwBinder == null)
      return null; 
    IHwInterface iHwInterface = paramIHwBinder.queryLocalInterface("android.hardware.radio@1.3::IRadioIndication");
    ...
    try {
      ...
      while (iterator.hasNext()) {
        boolean bool = ((String)iterator.next()).equals("android.hardware.radio@1.3::IRadioIndication");
        if (bool)
          return proxy; 
      } 
  ...
  static IRadioIndication getService(String paramString) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.radio@1.3::IRadioIndication", paramString));
  }
  
  static IRadioIndication getService(String paramString, boolean paramBoolean) throws RemoteException {
    return asInterface(HwBinder.getService("android.hardware.radio@1.3::IRadioIndication", paramString, paramBoolean));
  }
  ...
  public static abstract class Stub extends HwBinder implements IRadioIndication {
    ...
    public IHwInterface queryLocalInterface(String param1String) {
      return (IHwInterface)("android.hardware.radio@1.3::IRadioIndication".equals(param1String) ? this : null);
    }
...
/* Location:              /home/chun/Desktop/temp/!/android/hardware/radio/V1_3/IRadioIndication.class
